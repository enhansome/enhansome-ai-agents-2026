...
[![Stars](https://img.shields.io/github/stars/caramaschiHG/awesome-ai-agents-2026?style=flat-square\&color=yellow)](https://github.com/caramaschiHG/awesome-ai-agents-2026/stargazers) ⭐ 1,596 | 🐛 358 | 📅 2026-06-10
...
* [GNAP](https://github.com/farol-team/gnap) ⭐ 80 | 🐛 2 | 📅 2026-03-17 — Git-Native Agent Protocol: coordinate AI agent teams with 4 JSON files in a git repo. No server, no database. Any agent that can git push can participate. MIT licensed.
...
| [OpenAI Codex CLI](https://github.com/openai/codex) ⭐ 106,659 \| 🐛 12,974 \| 🌐 Rust \| 📅 2026-08-18          | OpenAI terminal agent. Agents SDK. Multi-agent.                                                                             | ChatGPT sub            |
| [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,561 \| 🐛 790 \| 🌐 TypeScript \| 📅 2026-08-18 | ⭐ **NEW (Apr 2026)** Google's official open-source terminal agent. ReAct loop. MCP support. 1M context. Apache 2.0.         | Free w/ Google account |
| [Aider](https://github.com/paul-gauthier/aider) ⭐ 48,310 \| 🐛 1,816 \| 🌐 Python \| 📅 2026-05-22              | OSS pair programmer. Git-aware. Any LLM.                                                                                    | Free + API             |
| [Cline](https://github.com/cline/cline) ⭐ 66,416 \| 🐛 1,037 \| 🌐 TypeScript \| 📅 2026-08-18                  | VS Code extension. Full terminal and browser access for Claude/GPT.                                                         | Free + API             |
...
| [SWE-Agent](https://github.com/princeton-nlp/SWE-agent) ⭐ 20,077 \| 🐛 82 \| 🌐 Python \| 📅 2026-08-17     | Princeton. Resolves real GitHub issues autonomously.                                   | Free (OSS)   |
| [OpenHands](https://github.com/All-Hands-AI/OpenHands) ⭐ 84,408 \| 🐛 482 \| 🌐 TypeScript \| 📅 2026-08-18 | OSS autonomous software engineer (ex-OpenDevin).                                       | Free (OSS)   |
...
| [PR-Agent](https://github.com/Codium-ai/pr-agent) ⭐ 12,600 \| 🐛 142 \| 🌐 Python \| 📅 2026-08-18 | OSS AI PR reviewer. Auto-describe, review, improve. | Free (OSS)        |
...
| [Dyad](https://github.com/dyad-sh/dyad) ⭐ 21,269 \| 🐛 292 \| 🌐 TypeScript \| 📅 2026-08-17 | OSS. Local-first. No-code app builder.     | Free (OSS)    |
...
| ------------------------------------------------------------------------------------------------------------------- | ---------- | --------------------------------------------------------------------------- |
| [LangChain](https://github.com/langchain-ai/langchain) ⭐ 144,489 \| 🐛 407 \| 🌐 Python \| 📅 2026-08-18            | Py/JS      | Most adopted. Modular architecture, memory, tools.                          |
| [LangGraph](https://github.com/langchain-ai/langgraph) ⭐ 39,943 \| 🐛 699 \| 🌐 Python \| 📅 2026-08-16             | Py/JS      | Graph-based orchestration. Stateful directed graphs.                        |
| [LlamaIndex](https://github.com/run-llama/llama_index) ⭐ 51,729 \| 🐛 625 \| 🌐 Python \| 📅 2026-08-18             | Py/JS      | Data-focused. Best for RAG agents.                                          |
| [Haystack](https://github.com/deepset-ai/haystack) ⭐ 26,242 \| 🐛 98 \| 🌐 Python \| 📅 2026-08-18                  | Py         | Pipeline-based. Search and retrieval.                                       |
| [Semantic Kernel](https://github.com/microsoft/semantic-kernel) ⭐ 28,461 \| 🐛 244 \| 🌐 C# \| 📅 2026-08-18        | C#/Py/Java | Microsoft enterprise. Azure integration.                                    |
| [Pydantic AI](https://github.com/pydantic/pydantic-ai) ⭐ 19,371 \| 🐛 722 \| 🌐 Python \| 📅 2026-08-18             | Py         | Type-safe. Clean Pythonic API. Production-ready.                            |
| [DSPy](https://github.com/stanfordnlp/dspy) ⭐ 37,385 \| 🐛 656 \| 🌐 Python \| 📅 2026-08-18                        | Py         | Stanford. Programming not prompting. Auto-optimizes.                        |
| [Mastra](https://github.com/mastra-ai/mastra) ⭐ 27,275 \| 🐛 439 \| 🌐 TypeScript \| 📅 2026-08-18                  | TS         | TypeScript-first. Observational Memory. Apache 2.0.                         |
| [Anthropic SDK](https://github.com/anthropics/anthropic-sdk-python) ⭐ 3,833 \| 🐛 142 \| 🌐 Python \| 📅 2026-08-18 | Py/TS      | Official Claude SDK. Tool use, computer control, streaming.                 |
| [Google ADK](https://github.com/google/adk-python) ⭐ 21,171 \| 🐛 552 \| 🌐 Python \| 📅 2026-08-18                 | Py         | ⭐ Google's Agent Development Kit. Native Gemini. Multi-agent orchestration. |

### Multi-Agent Orchestration

| Framework                                                                                                           | Lang               | Description                                                                                                            |
| ------------------------------------------------------------------------------------------------------------------- | ------------------ | ---------------------------------------------------------------------------------------------------------------------- |
| [AutoGen](https://github.com/microsoft/autogen) ⭐ 60,493 \| 🐛 995 \| 🌐 Python \| 📅 2026-04-15                    | Py                 | Microsoft multi-agent conversations.                                                                                   |
| [CrewAI](https://github.com/crewAIInc/crewAI) ⭐ 57,264 \| 🐛 822 \| 🌐 Python \| 📅 2026-08-18                      | Py                 | Role-based crew members with goals and tools. Used by 60%+ Fortune 500.                                                |
| [MetaGPT](https://github.com/geekan/MetaGPT) ⭐ 69,879 \| 🐛 129 \| 🌐 Python \| 📅 2026-01-21                       | Py                 | PM, architect, engineer roles. Software company sim.                                                                   |
...
| [OpenAI Agents SDK](https://github.com/openai/openai-agents-python) ⭐ 28,747 \| 🐛 22 \| 🌐 Python \| 📅 2026-08-18 | Py                 | Official. Multi-step agents with handoffs.                                                                             |
| [Strands Agents](https://github.com/strands-agents/sdk-python) ⭐ 6,939 \| 🐛 669 \| 🌐 Python \| 📅 2026-08-18      | Py                 | AWS-backed. Model-driven tool use.                                                                                     |
| [CAMEL](https://github.com/camel-ai/camel) ⭐ 17,603 \| 🐛 472 \| 🌐 Python \| 📅 2026-08-14                         | Py                 | Role-based simulation. Collaborative reasoning.                                                                        |
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) ⭐ 186,667 \| 🐛 506 \| 🌐 Python \| 📅 2026-08-18        | Py                 | Pioneer. Now full platform with visual builder.                                                                        |
| [Bernstein](https://github.com/chernistry/bernstein) ⭐ 928 \| 🐛 210 \| 🌐 Python \| 📅 2026-08-18                  | Py                 | Deterministic orchestrator. Parallel coding agents, test-driven verification. Zero LLM tokens on coordination.         |
| [AgentScope](https://github.com/modelscope/agentscope) ⭐ 29,028 \| 🐛 372 \| 🌐 Python \| 📅 2026-08-14             | Py                 | Alibaba multi-agent framework.                                                                                         |
...
| [DeerFlow](https://github.com/bytedance/deer-flow) ⭐ 80,256 \| 🐛 962 \| 🌐 Python \| 📅 2026-08-18                 | Py                 | ByteDance. No.1 GitHub Trending Feb 2026. 25k+ stars.                                                                  |
...
| Framework                                                                                                | Lang | Description                               |
| -------------------------------------------------------------------------------------------------------- | ---- | ----------------------------------------- |
| [Smolagents](https://github.com/huggingface/smolagents) ⭐ 28,866 \| 🐛 781 \| 🌐 Python \| 📅 2026-07-21 | Py   | HuggingFace minimal agents. \~1000 lines. |
| [Agno](https://github.com/agno-agi/agno) ⭐ 41,767 \| 🐛 1,258 \| 🌐 Python \| 📅 2026-08-18              | Py   | Lightweight, model-agnostic.              |
| [Upsonic](https://github.com/upsonic/upsonic) ⭐ 7,942 \| 🐛 30 \| 🌐 Python \| 📅 2026-06-18             | Py   | MCP support. Minimal setup.               |
...
| --------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [OpenClaw Agent Templates](https://github.com/mergisi/awesome-openclaw-agents) ⭐ 3,915 \| 🐛 85 \| 🌐 HTML \| 📅 2026-05-25 | 177 production-ready SOUL.md configs across 24 categories (PM, SEO, DevOps, Writer, Support). Copy-paste ready for [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 386,661 \| 🐛 5,719 \| 🌐 TypeScript \| 📅 2026-08-18. Visual deploy via [CrewClaw](https://crewclaw.com). |
...
| Tool                                                                                                             | Description                                                                                                                                      |
| ---------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Browser Use](https://github.com/browser-use/browser-use) ⭐ 109,635 \| 🐛 362 \| 🌐 Python \| 📅 2026-08-18      | OSS browser agent library. Used by Manus.                                                                                                        |
| [Skyvern](https://github.com/Skyvern-AI/skyvern) ⭐ 22,778 \| 🐛 213 \| 🌐 Python \| 📅 2026-08-18                | Vision-driven. GPT-4V navigation without coded selectors.                                                                                        |
| [Agent S2 (Simular)](https://github.com/simular-ai/Agent-S) ⭐ 12,167 \| 🐛 39 \| 🌐 Python \| 📅 2026-08-01      | OSS GUI automation framework.                                                                                                                    |
...
| [Plasmate](https://github.com/plasmate-labs/plasmate) ⭐ 34 \| 🐛 1 \| 🌐 Rust \| 📅 2026-08-18                   | Headless browser compiling HTML to structured JSON (SOM). 17.5x compression, 13 MCP tools. First browser tool on MCP Registry. Rust, Apache-2.0. |
| [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 36,244 \| 🐛 1 \| 🌐 TypeScript \| 📅 2026-08-17 | MCP server for Playwright + AI agents.                                                                                                           |
...
| Tool                                                                                                 | Description                                       |
| ---------------------------------------------------------------------------------------------------- | ------------------------------------------------- |
| [LiveKit Agents](https://github.com/livekit/agents) ⭐ 13,065 \| 🐛 763 \| 🌐 Python \| 📅 2026-08-18 | OSS real-time voice/video AI agents.              |
| [Rasa](https://github.com/RasaHQ/rasa) ⭐ 21,295 \| 🐛 153 \| 🌐 Python \| 📅 2026-07-24              | OSS conversational AI. Self-hosted. NLU training. |
| [Pipecat](https://github.com/pipecat-ai/pipecat) ⭐ 14,263 \| 🐛 236 \| 🌐 Python \| 📅 2026-08-18    | OSS voice and multimodal conversational AI.       |
...
| [InkOS](https://github.com/Narcooo/inkos) ⭐ 9,086 \| 🐛 226 \| 🌐 TypeScript \| 📅 2026-08-17 | Autonomous novel-writing CLI agent. Agents collaborate to produce long-form fiction with continuity auditing, anti-AI-slop filtering, and style cloning. | Free / OSS     |
...
| [Wan 2.1](https://github.com/Wan-Video/Wan2.1) ⭐ 16,852 \| 🐛 376 \| 🌐 Python \| 📅 2026-03-05          | Best free OSS video gen. Self-hostable. No limits.                                 | Free (OSS)       |
| [HunyuanVideo](https://github.com/Tencent/HunyuanVideo) ⭐ 12,437 \| 🐛 183 \| 🌐 Python \| 📅 2026-06-29 | Tencent OSS. Consumer GPU. Multi-style.                                            | Free (OSS)       |
| [LTX Video](https://github.com/Lightricks/LTX-Video) ⭐ 10,861 \| 🐛 99 \| 🌐 Python \| 📅 2026-01-05     | OSS. Licensed data. Clear commercial terms.                                        | Free (OSS)       |
...
| Agent                                                                                                             | Description                                                                                                                              | Pricing        |
| ----------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- | -------------- |
| [n8n](https://github.com/n8n-io/n8n) ⭐ 201,095 \| 🐛 1,128 \| 🌐 TypeScript \| 📅 2026-08-18                      | OSS workflow automation with AI agent nodes. Visual + code.                                                                              | Free / Cloud   |
...
| [Activepieces](https://github.com/activepieces/activepieces) ⭐ 23,873 \| 🐛 468 \| 🌐 TypeScript \| 📅 2026-08-18 | OSS Zapier alternative with AI.                                                                                                          | Free (OSS)     |
| [Temporal](https://github.com/temporalio/temporal) ⭐ 22,388 \| 🐛 898 \| 🌐 Go \| 📅 2026-08-18                   | Durable execution for long-running agent workflows.                                                                                      | Free / Cloud   |
...
| Agent                                                                                                 | Description                                                                                                                                            | Pricing      |
| ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------ |
| [Dify](https://github.com/langgenius/dify) ⭐ 152,817 \| 🐛 981 \| 🌐 TypeScript \| 📅 2026-08-18      | OSS LLMOps. Visual agent builder. RAG. 130k+ stars.                                                                                                    | Free / Cloud |
| [Flowise](https://github.com/FlowiseAI/Flowise) ⚠️ Archived                                           | OSS drag-and-drop LLM agent builder.                                                                                                                   | Free (OSS)   |
| [Langflow](https://github.com/langflow-ai/langflow) ⭐ 153,422 \| 🐛 974 \| 🌐 Python \| 📅 2026-08-18 | Visual multi-agent and RAG builder.                                                                                                                    | Free / Cloud |
...
| [DeerFlow](https://github.com/bytedance/deer-flow) ⭐ 80,256 \| 🐛 962 \| 🌐 Python \| 📅 2026-08-18              | ByteDance OSS. Planning, tools, memory, execution.            | Free (OSS)      |
| [GPT Researcher](https://github.com/assafelovic/gpt-researcher) ⭐ 29,026 \| 🐛 177 \| 🌐 Python \| 📅 2026-07-18 | OSS autonomous comprehensive research.                        | Free (OSS)      |
| [STORM](https://github.com/stanford-oval/storm) ⭐ 31,055 \| 🐛 107 \| 🌐 Python \| 📅 2025-09-30                 | Stanford. Writes Wikipedia-like articles from scratch.        | Free (OSS)      |
...
| Tool                                                                                                                                                                                                                                                                                                                                                                    | Description                                                                             |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| [RAGFlow](https://github.com/infiniflow/ragflow) ⭐ 88,764 \| 🐛 1,802 \| 🌐 Go \| 📅 2026-08-18                                                                                                                                                                                                                                                                         | OSS RAG engine with agent capabilities.                                                 |
...
| [Pathway](https://github.com/pathwaycom/pathway) ⭐ 62,428 \| 🐛 35 \| 🌐 Python \| 📅 2026-08-18                                                                                                                                                                                                                                                                        | Live data RAG. Real-time streaming. 50k+ stars.                                         |
| [Mem0](https://github.com/mem0ai/mem0) ⭐ 63,535 \| 🐛 689 \| 🌐 Python \| 📅 2026-08-18                                                                                                                                                                                                                                                                                 | Memory layer for agents. Long-term across sessions.                                     |
...
| [Chroma](https://github.com/chroma-core/chroma) ⭐ 29,078 \| 🐛 791 \| 🌐 Rust \| 📅 2026-08-18                                                                                                                                                                                                                                                                          | OSS embedding database. Fastest way to build RAG.                                       |
| [Weaviate](https://github.com/weaviate/weaviate) ⭐ 16,741 \| 🐛 690 \| 🌐 Go \| 📅 2026-08-18                                                                                                                                                                                                                                                                           | OSS vector DB. GraphQL. Multi-modal search.                                             |
| [Qdrant](https://github.com/qdrant/qdrant) ⭐ 34,046 \| 🐛 687 \| 🌐 Rust \| 📅 2026-08-18                                                                                                                                                                                                                                                                               | High-performance vector DB in Rust.                                                     |
| [Milvus](https://github.com/milvus-io/milvus) ⭐ 45,678 \| 🐛 1,303 \| 🌐 Go \| 📅 2026-08-18                                                                                                                                                                                                                                                                            | Cloud-native vector DB. Billion-scale.                                                  |
...
| Tool                                                                                                 | Description                                                       |
| ---------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| [Ollama](https://github.com/ollama/ollama) ⭐ 178,884 \| 🐛 3,749 \| 🌐 Go \| 📅 2026-08-16           | Run LLMs locally. 162k+ stars. Dead simple CLI.                   |
| [llama.cpp](https://github.com/ggml-org/llama.cpp) ⭐ 124,517 \| 🐛 2,108 \| 🌐 C++ \| 📅 2026-08-18  | C/C++ inference. CPU, GPU, Apple Silicon. Foundation of local AI. |
| [vLLM](https://github.com/vllm-project/vllm) ⭐ 89,363 \| 🐛 6,740 \| 🌐 Python \| 📅 2026-08-18      | High-throughput serving. PagedAttention. Production-grade.        |
| [LM Studio](https://lmstudio.ai)                                                                     | Desktop app for local LLMs. Beautiful UI. All platforms.          |
| [Jan](https://github.com/janhq/jan) ⭐ 44,045 \| 🐛 455 \| 🌐 TypeScript \| 📅 2026-08-18             | OSS ChatGPT alternative. 100% offline.                            |
| [LocalAI](https://github.com/mudler/LocalAI) ⭐ 48,554 \| 🐛 160 \| 🌐 Go \| 📅 2026-08-18            | Drop-in OpenAI API replacement. No GPU required.                  |
...
| [Llamafile](https://github.com/Mozilla-Ocho/llamafile) ⭐ 25,629 \| 🐛 213 \| 🌐 C++ \| 📅 2026-08-17 | LLMs as single files. Zero setup. Mozilla.                        |

### Self-Hosted Agents and UIs

| Tool                                                                                                               | Description                                                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Open WebUI](https://github.com/open-webui/open-webui) ⭐ 149,135 \| 🐛 363 \| 🌐 Python \| 📅 2026-08-18           | Self-hosted ChatGPT UI. Access control. Extensions.                                                                                                                                                            |
| [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 386,661 \| 🐛 5,719 \| 🌐 TypeScript \| 📅 2026-08-18           | Fastest-growing GitHub repo ever (9k to 188k stars in 60 days). Self-hosted agent across WhatsApp, Telegram, Slack, Discord, Signal. 5,700+ community skills.                                                  |
...
| [LibreChat](https://github.com/danny-avila/LibreChat) ⭐ 42,194 \| 🐛 710 \| 🌐 TypeScript \| 📅 2026-08-18         | Self-hosted multi-model chat. All major providers.                                                                                                                                                             |
| [LobeChat](https://github.com/lobehub/lobe-chat) ⭐ 81,806 \| 🐛 768 \| 🌐 TypeScript \| 📅 2026-08-18              | OSS ChatGPT/Gemini UI. Plugin system. Multi-modal.                                                                                                                                                             |
...
| [Anything LLM](https://github.com/Mintplex-Labs/anything-llm) ⭐ 64,884 \| 🐛 328 \| 🌐 JavaScript \| 📅 2026-08-18 | All-in-one AI app. RAG, agents. Desktop + Docker.                                                                                                                                                              |
| [DB-GPT](https://github.com/eosphoros-ai/DB-GPT) ⭐ 19,744 \| 🐛 428 \| 🌐 Python \| 📅 2026-08-17                  | Data interaction with local LLM. 100% private.                                                                                                                                                                 |
...
| [Cursor AI Automated Team](https://github.com/joinwell52-AI/joinwell52) ⭐ 4 \| 🐛 3 \| 🌐 JavaScript \| 📅 2026-08-18 | 4-role AI team (PM+DEV+OPS+QA) in Cursor IDE. File-based task routing, auto patrol bot. 87 person-days in 17 days.                                | Free / OSS        |
...
| [A2A (Agent-to-Agent)](https://github.com/google/A2A) ⭐ 25,399 \| 🐛 229 \| 🌐 Shell \| 📅 2026-08-18      | Google protocol for inter-agent communication. Horizontal agent collaboration.                                                                     |
...
| [OpenAPI](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,161 \| 🐛 120 \| 🌐 Markdown \| 📅 2026-08-18 | Industry-standard API spec. Foundation for agent tools.                                                                                            |
...
| Tool                                                                                            | Description                                                                                                                                                                            |
| ----------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Entroly](https://github.com/juyterman1000/entroly) ⭐ 437 \| 🐛 9 \| 🌐 Python \| 📅 2026-08-18 | Context engineering engine. 100% codebase visibility with 78% fewer tokens. Knapsack-optimal selection, SimHash dedup, RL from response quality. Rust engine, <10ms. MCP + HTTP proxy. |

### Tracing and Monitoring

| Tool                                                                                                     | Description                                                                                                                          |
| -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| [Langfuse](https://github.com/langfuse/langfuse) ⭐ 33,339 \| 🐛 791 \| 🌐 TypeScript \| 📅 2026-08-18    | OSS LLM observability. Traces, evals, prompts.                                                                                       |
...
| [Arize Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,095 \| 🐛 930 \| 🌐 Python \| 📅 2026-08-18    | OSS AI observability. Traces, evals, embeddings.                                                                                     |
| [Helicone](https://github.com/Helicone/helicone) ⭐ 6,082 \| 🐛 148 \| 🌐 TypeScript \| 📅 2026-08-16     | OSS LLM observability. One-line integration.                                                                                         |
...
| ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| [SWE-bench](https://github.com/princeton-nlp/SWE-bench) ⭐ 5,664 \| 🐛 7 \| 🌐 Python \| 📅 2026-08-18 | Industry standard for coding agents. Top: 80.9% (Claude Opus 4.6). |
...
| [WebArena](https://github.com/web-arena-x/webarena) ⭐ 1,583 \| 🐛 100 \| 🌐 Python \| 📅 2025-11-26   | Web agent benchmark. Real websites.                                |
...
| [Qwen3.6-Plus](https://github.com/QwenLM/Qwen3) ⭐ 27,528 \| 🐛 65 \| 🌐 Python \| 📅 2026-01-09                | Alibaba   | Various   | ⭐ **NEW (Apr 2026)** Agentic focus. 1M ctx. Repo-level coding. MCP-native. |
| [Qwen3.5-Omni](https://github.com/QwenLM/Qwen3) ⭐ 27,528 \| 🐛 65 \| 🌐 Python \| 📅 2026-01-09                | Alibaba   | 397B MoE  | Native multimodal. Text, image, audio.                                     |
| [DeepSeek V3/R1](https://github.com/deepseek-ai/DeepSeek-V3) ⭐ 104,327 \| 🐛 211 \| 🌐 Python \| 📅 2025-08-28 | DeepSeek  | 671B MoE  | 68x cheaper. Strong reasoning. V4 Lite in preview.                         |
| [Gemma 4](https://github.com/google-deepmind/gemma) ⭐ 5,666 \| 🐛 315 \| 🌐 Python \| 📅 2026-08-10            | Google    | 2B-31B    | ⭐ **NEW (Apr 2026)** Consumer/IoT optimized. E2B, E4B variants.            |
...
| Tool                                                                                                         | Description                                                                      |
| ------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------- |
| [Guardrails AI](https://github.com/guardrails-ai/guardrails) ⭐ 7,296 \| 🐛 87 \| 🌐 Python \| 📅 2026-08-18  | Structural, type, quality guarantees for LLM outputs.                            |
| [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) ⭐ 6,969 \| 🐛 222 \| 🌐 Python \| 📅 2026-08-18 | NVIDIA. Programmable conversation guardrails.                                    |
...
| Agent                                                                                                       | Description                                                                                                                 |
| ----------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| [CAI](https://github.com/aliasrobotics/CAI) ⭐ 9,758 \| 🐛 17 \| 🌐 Python \| 📅 2026-07-14                  | AI pentesting, vuln discovery, red teaming. HITL.                                                                           |
| [YAWNING TITAN](https://github.com/dstl/YAWNING-TITAN) ⚠️ Archived                                          | Graph-based cybersecurity simulation.                                                                                       |
| [PentestGPT](https://github.com/GreyDGL/PentestGPT) ⭐ 14,932 \| 🐛 66 \| 🌐 Python \| 📅 2026-07-14         | GPT-powered pentesting. Automated reasoning.                                                                                |
...
* [Microsoft GenAI for Beginners](https://github.com/microsoft/generative-ai-for-beginners) ⭐ 118,024 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2026-08-13 - 21-lesson course
* [OpenAI Cookbook](https://github.com/openai/openai-cookbook) ⭐ 75,324 | 🐛 247 | 🌐 Jupyter Notebook | 📅 2026-08-18 - Practical API guides
* [Anthropic Cookbook](https://github.com/anthropics/anthropic-cookbook) ⭐ 51,793 | 🐛 311 | 🌐 Jupyter Notebook | 📅 2026-08-14 - Claude agent recipes
