...
[![Stars](https://img.shields.io/github/stars/caramaschiHG/awesome-ai-agents-2026?style=flat-square\&color=yellow)](https://github.com/caramaschiHG/awesome-ai-agents-2026/stargazers) ⭐ 1,678 | 🐛 367 | 📅 2026-06-10
...
| [OpenAI Codex CLI](https://github.com/openai/codex) ⭐ 119,219 \| 🐛 14,142 \| 🌐 Rust \| 📅 2026-08-28          | OpenAI terminal agent. Agents SDK. Multi-agent.                                                                             | ChatGPT sub            |
| [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,720 \| 🐛 870 \| 🌐 TypeScript \| 📅 2026-08-27 | ⭐ **NEW (Apr 2026)** Google's official open-source terminal agent. ReAct loop. MCP support. 1M context. Apache 2.0.         | Free w/ Google account |
| [Aider](https://github.com/paul-gauthier/aider) ⭐ 48,536 \| 🐛 1,827 \| 🌐 Python \| 📅 2026-05-22              | OSS pair programmer. Git-aware. Any LLM.                                                                                    | Free + API             |
| [Cline](https://github.com/cline/cline) ⭐ 67,022 \| 🐛 1,120 \| 🌐 TypeScript \| 📅 2026-08-28                  | VS Code extension. Full terminal and browser access for Claude/GPT.                                                         | Free + API             |
...
| [SWE-Agent](https://github.com/princeton-nlp/SWE-agent) ⭐ 20,158 \| 🐛 82 \| 🌐 Python \| 📅 2026-08-24     | Princeton. Resolves real GitHub issues autonomously.                                   | Free (OSS)   |
| [OpenHands](https://github.com/All-Hands-AI/OpenHands) ⭐ 85,323 \| 🐛 588 \| 🌐 TypeScript \| 📅 2026-08-27 | OSS autonomous software engineer (ex-OpenDevin).                                       | Free (OSS)   |
...
| [PR-Agent](https://github.com/Codium-ai/pr-agent) ⭐ 12,736 \| 🐛 92 \| 🌐 Python \| 📅 2026-08-27 | OSS AI PR reviewer. Auto-describe, review, improve. | Free (OSS)        |
...
| [Dyad](https://github.com/dyad-sh/dyad) ⭐ 21,324 \| 🐛 287 \| 🌐 TypeScript \| 📅 2026-08-28 | OSS. Local-first. No-code app builder.     | Free (OSS)    |
...
| ------------------------------------------------------------------------------------------------------------------- | ---------- | --------------------------------------------------------------------------- |
| [LangChain](https://github.com/langchain-ai/langchain) ⭐ 145,151 \| 🐛 428 \| 🌐 Python \| 📅 2026-08-27            | Py/JS      | Most adopted. Modular architecture, memory, tools.                          |
| [LangGraph](https://github.com/langchain-ai/langgraph) ⭐ 40,570 \| 🐛 722 \| 🌐 Python \| 📅 2026-08-28             | Py/JS      | Graph-based orchestration. Stateful directed graphs.                        |
| [LlamaIndex](https://github.com/run-llama/llama_index) ⭐ 51,894 \| 🐛 667 \| 🌐 Python \| 📅 2026-08-28             | Py/JS      | Data-focused. Best for RAG agents.                                          |
| [Haystack](https://github.com/deepset-ai/haystack) ⭐ 26,346 \| 🐛 114 \| 🌐 Python \| 📅 2026-08-27                 | Py         | Pipeline-based. Search and retrieval.                                       |
| [Semantic Kernel](https://github.com/microsoft/semantic-kernel) ⭐ 28,507 \| 🐛 262 \| 🌐 C# \| 📅 2026-08-27        | C#/Py/Java | Microsoft enterprise. Azure integration.                                    |
| [Pydantic AI](https://github.com/pydantic/pydantic-ai) ⭐ 19,541 \| 🐛 750 \| 🌐 Python \| 📅 2026-08-28             | Py         | Type-safe. Clean Pythonic API. Production-ready.                            |
| [DSPy](https://github.com/stanfordnlp/dspy) ⭐ 37,627 \| 🐛 635 \| 🌐 Python \| 📅 2026-08-27                        | Py         | Stanford. Programming not prompting. Auto-optimizes.                        |
| [Mastra](https://github.com/mastra-ai/mastra) ⭐ 27,527 \| 🐛 507 \| 🌐 TypeScript \| 📅 2026-08-28                  | TS         | TypeScript-first. Observational Memory. Apache 2.0.                         |
| [Anthropic SDK](https://github.com/anthropics/anthropic-sdk-python) ⭐ 3,860 \| 🐛 148 \| 🌐 Python \| 📅 2026-08-27 | Py/TS      | Official Claude SDK. Tool use, computer control, streaming.                 |
| [Google ADK](https://github.com/google/adk-python) ⭐ 21,310 \| 🐛 532 \| 🌐 Python \| 📅 2026-08-28                 | Py         | ⭐ Google's Agent Development Kit. Native Gemini. Multi-agent orchestration. |

### Multi-Agent Orchestration

| Framework                                                                                                           | Lang               | Description                                                                                                            |
| ------------------------------------------------------------------------------------------------------------------- | ------------------ | ---------------------------------------------------------------------------------------------------------------------- |
| [AutoGen](https://github.com/microsoft/autogen) ⭐ 60,659 \| 🐛 989 \| 🌐 Python \| 📅 2026-04-15                    | Py                 | Microsoft multi-agent conversations.                                                                                   |
| [CrewAI](https://github.com/crewAIInc/crewAI) ⭐ 57,687 \| 🐛 775 \| 🌐 Python \| 📅 2026-08-27                      | Py                 | Role-based crew members with goals and tools. Used by 60%+ Fortune 500.                                                |
| [MetaGPT](https://github.com/geekan/MetaGPT) ⭐ 70,071 \| 🐛 133 \| 🌐 Python \| 📅 2026-01-21                       | Py                 | PM, architect, engineer roles. Software company sim.                                                                   |
...
| [OpenAI Agents SDK](https://github.com/openai/openai-agents-python) ⭐ 29,016 \| 🐛 28 \| 🌐 Python \| 📅 2026-08-28 | Py                 | Official. Multi-step agents with handoffs.                                                                             |
| [Strands Agents](https://github.com/strands-agents/sdk-python) ⭐ 7,033 \| 🐛 676 \| 🌐 Python \| 📅 2026-08-27      | Py                 | AWS-backed. Model-driven tool use.                                                                                     |
| [CAMEL](https://github.com/camel-ai/camel) ⭐ 17,650 \| 🐛 485 \| 🌐 Python \| 📅 2026-08-27                         | Py                 | Role-based simulation. Collaborative reasoning.                                                                        |
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) ⭐ 186,939 \| 🐛 514 \| 🌐 Python \| 📅 2026-08-28        | Py                 | Pioneer. Now full platform with visual builder.                                                                        |
| [Bernstein](https://github.com/chernistry/bernstein) ⭐ 1,014 \| 🐛 164 \| 🌐 Python \| 📅 2026-08-28                | Py                 | Deterministic orchestrator. Parallel coding agents, test-driven verification. Zero LLM tokens on coordination.         |
| [AgentScope](https://github.com/modelscope/agentscope) ⭐ 29,839 \| 🐛 364 \| 🌐 Python \| 📅 2026-08-27             | Py                 | Alibaba multi-agent framework.                                                                                         |
...
| [DeerFlow](https://github.com/bytedance/deer-flow) ⭐ 81,021 \| 🐛 912 \| 🌐 Python \| 📅 2026-08-28                 | Py                 | ByteDance. No.1 GitHub Trending Feb 2026. 25k+ stars.                                                                  |
...
| Framework                                                                                                | Lang | Description                               |
| -------------------------------------------------------------------------------------------------------- | ---- | ----------------------------------------- |
| [Smolagents](https://github.com/huggingface/smolagents) ⭐ 29,022 \| 🐛 736 \| 🌐 Python \| 📅 2026-08-25 | Py   | HuggingFace minimal agents. \~1000 lines. |
| [Agno](https://github.com/agno-agi/agno) ⭐ 41,946 \| 🐛 1,277 \| 🌐 Python \| 📅 2026-08-28              | Py   | Lightweight, model-agnostic.              |
...
| --------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [OpenClaw Agent Templates](https://github.com/mergisi/awesome-openclaw-agents) ⭐ 3,942 \| 🐛 86 \| 🌐 HTML \| 📅 2026-05-25 | 177 production-ready SOUL.md configs across 24 categories (PM, SEO, DevOps, Writer, Support). Copy-paste ready for [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 387,852 \| 🐛 5,713 \| 🌐 TypeScript \| 📅 2026-08-28. Visual deploy via [CrewClaw](https://crewclaw.com). |
...
| Tool                                                                                                             | Description                                                                                                                                      |
| ---------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Browser Use](https://github.com/browser-use/browser-use) ⭐ 111,460 \| 🐛 384 \| 🌐 Python \| 📅 2026-08-28      | OSS browser agent library. Used by Manus.                                                                                                        |
| [Skyvern](https://github.com/Skyvern-AI/skyvern) ⭐ 22,865 \| 🐛 218 \| 🌐 Python \| 📅 2026-08-27                | Vision-driven. GPT-4V navigation without coded selectors.                                                                                        |
| [Agent S2 (Simular)](https://github.com/simular-ai/Agent-S) ⭐ 12,200 \| 🐛 41 \| 🌐 Python \| 📅 2026-08-01      | OSS GUI automation framework.                                                                                                                    |
...
| [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 36,553 \| 🐛 4 \| 🌐 TypeScript \| 📅 2026-08-27 | MCP server for Playwright + AI agents.                                                                                                           |
| [onUI](https://github.com/onllm-dev/onUI) ⭐ 96 \| 🐛 1 \| 🌐 TypeScript \| 📅 2026-04-28                         | OSS browser extension and MCP server for annotation-first UI pair programming with AI agents. Chrome, Edge, Firefox. Privacy-first, local only.  |
...
| Tool                                                                                                 | Description                                       |
| ---------------------------------------------------------------------------------------------------- | ------------------------------------------------- |
| [LiveKit Agents](https://github.com/livekit/agents) ⭐ 13,193 \| 🐛 795 \| 🌐 Python \| 📅 2026-08-27 | OSS real-time voice/video AI agents.              |
| [Rasa](https://github.com/RasaHQ/rasa) ⭐ 21,310 \| 🐛 153 \| 🌐 Python \| 📅 2026-07-24              | OSS conversational AI. Self-hosted. NLU training. |
| [Pipecat](https://github.com/pipecat-ai/pipecat) ⭐ 14,832 \| 🐛 238 \| 🌐 Python \| 📅 2026-08-28    | OSS voice and multimodal conversational AI.       |
| [Vocode](https://github.com/vocodedev/vocode-python) ⭐ 3,784 \| 🐛 1 \| 🌐 Python \| 📅 2024-11-15   | OSS voice-based LLM agents.                       |
...
| [InkOS](https://github.com/Narcooo/inkos) ⭐ 9,312 \| 🐛 231 \| 🌐 TypeScript \| 📅 2026-08-25 | Autonomous novel-writing CLI agent. Agents collaborate to produce long-form fiction with continuity auditing, anti-AI-slop filtering, and style cloning. | Free / OSS     |
...
| [Wan 2.1](https://github.com/Wan-Video/Wan2.1) ⭐ 16,897 \| 🐛 378 \| 🌐 Python \| 📅 2026-03-05          | Best free OSS video gen. Self-hostable. No limits.                                 | Free (OSS)       |
| [HunyuanVideo](https://github.com/Tencent/HunyuanVideo) ⭐ 12,483 \| 🐛 183 \| 🌐 Python \| 📅 2026-06-29 | Tencent OSS. Consumer GPU. Multi-style.                                            | Free (OSS)       |
| [LTX Video](https://github.com/Lightricks/LTX-Video) ⭐ 10,910 \| 🐛 99 \| 🌐 Python \| 📅 2026-01-05     | OSS. Licensed data. Clear commercial terms.                                        | Free (OSS)       |
...
| [Meta AudioCraft](https://github.com/facebookresearch/audiocraft) ⭐ 23,587 \| 🐛 394 \| 🌐 Jupyter Notebook \| 📅 2026-03-03 | OSS. MusicGen + AudioGen.                                  | Free (OSS)     |
...
| Agent                                                                                                             | Description                                                                                                                              | Pricing        |
| ----------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- | -------------- |
| [n8n](https://github.com/n8n-io/n8n) ⭐ 202,635 \| 🐛 1,096 \| 🌐 TypeScript \| 📅 2026-08-28                      | OSS workflow automation with AI agent nodes. Visual + code.                                                                              | Free / Cloud   |
...
| [Activepieces](https://github.com/activepieces/activepieces) ⭐ 24,065 \| 🐛 504 \| 🌐 TypeScript \| 📅 2026-08-28 | OSS Zapier alternative with AI.                                                                                                          | Free (OSS)     |
| [Temporal](https://github.com/temporalio/temporal) ⭐ 22,573 \| 🐛 927 \| 🌐 Go \| 📅 2026-08-28                   | Durable execution for long-running agent workflows.                                                                                      | Free / Cloud   |
| [Mission Control](https://github.com/MeisnerDan/mission-control) ⭐ 929 \| 🐛 17 \| 🌐 TypeScript \| 📅 2026-04-01 | Cockpit for the agentic era — manage AI agent swarms with autonomous daemon, Field Ops for real-world execution, and approval workflows. | Free (OSS)     |

### No-Code Agent Builders

| Agent                                                                                                 | Description                                                                                                                                            | Pricing      |
| ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------ |
| [Dify](https://github.com/langgenius/dify) ⭐ 153,693 \| 🐛 964 \| 🌐 TypeScript \| 📅 2026-08-28      | OSS LLMOps. Visual agent builder. RAG. 130k+ stars.                                                                                                    | Free / Cloud |
| [Flowise](https://github.com/FlowiseAI/Flowise) ⚠️ Archived                                           | OSS drag-and-drop LLM agent builder.                                                                                                                   | Free (OSS)   |
| [Langflow](https://github.com/langflow-ai/langflow) ⭐ 153,748 \| 🐛 994 \| 🌐 Python \| 📅 2026-08-28 | Visual multi-agent and RAG builder.                                                                                                                    | Free / Cloud |
...
| [DeerFlow](https://github.com/bytedance/deer-flow) ⭐ 81,021 \| 🐛 912 \| 🌐 Python \| 📅 2026-08-28             | ByteDance OSS. Planning, tools, memory, execution.            | Free (OSS)      |
| [GPT Researcher](https://github.com/assafelovic/gpt-researcher) ⭐ 29,175 \| 🐛 57 \| 🌐 Python \| 📅 2026-08-27 | OSS autonomous comprehensive research.                        | Free (OSS)      |
| [STORM](https://github.com/stanford-oval/storm) ⭐ 31,141 \| 🐛 107 \| 🌐 Python \| 📅 2025-09-30                | Stanford. Writes Wikipedia-like articles from scratch.        | Free (OSS)      |
...
| [PandasAI](https://github.com/Sinaptik-AI/pandas-ai) ⭐ 23,776 \| 🐛 22 \| 🌐 Python \| 📅 2025-10-28 | Chat with your data. NL to Pandas/SQL.                                                                                                                                                            | Free (OSS)  |
...
| Tool                                                                                                                                                                                                                                                                                                                                                                    | Description                                                                             |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| [RAGFlow](https://github.com/infiniflow/ragflow) ⭐ 89,411 \| 🐛 1,732 \| 🌐 Go \| 📅 2026-08-28                                                                                                                                                                                                                                                                         | OSS RAG engine with agent capabilities.                                                 |
...
| [Pathway](https://github.com/pathwaycom/pathway) ⭐ 62,375 \| 🐛 35 \| 🌐 Python \| 📅 2026-08-27                                                                                                                                                                                                                                                                        | Live data RAG. Real-time streaming. 50k+ stars.                                         |
| [Mem0](https://github.com/mem0ai/mem0) ⭐ 64,208 \| 🐛 698 \| 🌐 Python \| 📅 2026-08-27                                                                                                                                                                                                                                                                                 | Memory layer for agents. Long-term across sessions.                                     |
...
| [Chroma](https://github.com/chroma-core/chroma) ⭐ 29,166 \| 🐛 806 \| 🌐 Rust \| 📅 2026-08-27                                                                                                                                                                                                                                                                          | OSS embedding database. Fastest way to build RAG.                                       |
| [Weaviate](https://github.com/weaviate/weaviate) ⭐ 16,757 \| 🐛 692 \| 🌐 Go \| 📅 2026-08-27                                                                                                                                                                                                                                                                           | OSS vector DB. GraphQL. Multi-modal search.                                             |
| [Qdrant](https://github.com/qdrant/qdrant) ⭐ 34,229 \| 🐛 710 \| 🌐 Rust \| 📅 2026-08-27                                                                                                                                                                                                                                                                               | High-performance vector DB in Rust.                                                     |
| [Milvus](https://github.com/milvus-io/milvus) ⭐ 45,834 \| 🐛 1,331 \| 🌐 Go \| 📅 2026-08-28                                                                                                                                                                                                                                                                            | Cloud-native vector DB. Billion-scale.                                                  |
...
| Tool                                                                                                 | Description                                                       |
| ---------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| [Ollama](https://github.com/ollama/ollama) ⭐ 179,587 \| 🐛 3,810 \| 🌐 Go \| 📅 2026-08-28           | Run LLMs locally. 162k+ stars. Dead simple CLI.                   |
| [llama.cpp](https://github.com/ggml-org/llama.cpp) ⭐ 125,974 \| 🐛 2,249 \| 🌐 C++ \| 📅 2026-08-28  | C/C++ inference. CPU, GPU, Apple Silicon. Foundation of local AI. |
| [vLLM](https://github.com/vllm-project/vllm) ⭐ 90,250 \| 🐛 7,137 \| 🌐 Python \| 📅 2026-08-28      | High-throughput serving. PagedAttention. Production-grade.        |
| [LM Studio](https://lmstudio.ai)                                                                     | Desktop app for local LLMs. Beautiful UI. All platforms.          |
| [Jan](https://github.com/janhq/jan) ⭐ 44,214 \| 🐛 493 \| 🌐 TypeScript \| 📅 2026-08-27             | OSS ChatGPT alternative. 100% offline.                            |
| [LocalAI](https://github.com/mudler/LocalAI) ⭐ 48,711 \| 🐛 222 \| 🌐 Go \| 📅 2026-08-27            | Drop-in OpenAI API replacement. No GPU required.                  |
...
| [Llamafile](https://github.com/Mozilla-Ocho/llamafile) ⭐ 25,707 \| 🐛 212 \| 🌐 C++ \| 📅 2026-08-26 | LLMs as single files. Zero setup. Mozilla.                        |

### Self-Hosted Agents and UIs

| Tool                                                                                                               | Description                                                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Open WebUI](https://github.com/open-webui/open-webui) ⭐ 150,148 \| 🐛 210 \| 🌐 Python \| 📅 2026-08-27           | Self-hosted ChatGPT UI. Access control. Extensions.                                                                                                                                                            |
| [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 387,852 \| 🐛 5,713 \| 🌐 TypeScript \| 📅 2026-08-28           | Fastest-growing GitHub repo ever (9k to 188k stars in 60 days). Self-hosted agent across WhatsApp, Telegram, Slack, Discord, Signal. 5,700+ community skills.                                                  |
...
| [LibreChat](https://github.com/danny-avila/LibreChat) ⭐ 42,533 \| 🐛 731 \| 🌐 TypeScript \| 📅 2026-08-28         | Self-hosted multi-model chat. All major providers.                                                                                                                                                             |
| [LobeChat](https://github.com/lobehub/lobe-chat) ⭐ 82,047 \| 🐛 822 \| 🌐 TypeScript \| 📅 2026-08-28              | OSS ChatGPT/Gemini UI. Plugin system. Multi-modal.                                                                                                                                                             |
...
| [Anything LLM](https://github.com/Mintplex-Labs/anything-llm) ⭐ 65,306 \| 🐛 332 \| 🌐 JavaScript \| 📅 2026-08-28 | All-in-one AI app. RAG, agents. Desktop + Docker.                                                                                                                                                              |
| [DB-GPT](https://github.com/eosphoros-ai/DB-GPT) ⭐ 19,812 \| 🐛 423 \| 🌐 Python \| 📅 2026-08-26                  | Data interaction with local LLM. 100% private.                                                                                                                                                                 |
...
| [Cursor AI Automated Team](https://github.com/joinwell52-AI/joinwell52) ⭐ 5 \| 🐛 4 \| 🌐 JavaScript \| 📅 2026-08-28 | 4-role AI team (PM+DEV+OPS+QA) in Cursor IDE. File-based task routing, auto patrol bot. 87 person-days in 17 days.                                | Free / OSS        |
...
| [A2A (Agent-to-Agent)](https://github.com/google/A2A) ⭐ 25,519 \| 🐛 242 \| 🌐 Shell \| 📅 2026-08-25     | Google protocol for inter-agent communication. Horizontal agent collaboration.                                                                     |
...
| [OpenAPI](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,187 \| 🐛 76 \| 🌐 Markdown \| 📅 2026-08-27 | Industry-standard API spec. Foundation for agent tools.                                                                                            |
...
| Tool                                                                                                     | Description                                                                                                                          |
| -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| [Langfuse](https://github.com/langfuse/langfuse) ⭐ 33,823 \| 🐛 836 \| 🌐 TypeScript \| 📅 2026-08-27    | OSS LLM observability. Traces, evals, prompts.                                                                                       |
...
| [Arize Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,219 \| 🐛 921 \| 🌐 Python \| 📅 2026-08-28    | OSS AI observability. Traces, evals, embeddings.                                                                                     |
| [Helicone](https://github.com/Helicone/helicone) ⭐ 6,106 \| 🐛 152 \| 🌐 TypeScript \| 📅 2026-08-26     | OSS LLM observability. One-line integration.                                                                                         |
...
| ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------ |
| [SWE-bench](https://github.com/princeton-nlp/SWE-bench) ⭐ 5,725 \| 🐛 17 \| 🌐 Python \| 📅 2026-08-18 | Industry standard for coding agents. Top: 80.9% (Claude Opus 4.6). |
...
| [Qwen3.6-Plus](https://github.com/QwenLM/Qwen3) ⭐ 27,565 \| 🐛 65 \| 🌐 Python \| 📅 2026-01-09                | Alibaba   | Various   | ⭐ **NEW (Apr 2026)** Agentic focus. 1M ctx. Repo-level coding. MCP-native. |
| [Qwen3.5-Omni](https://github.com/QwenLM/Qwen3) ⭐ 27,565 \| 🐛 65 \| 🌐 Python \| 📅 2026-01-09                | Alibaba   | 397B MoE  | Native multimodal. Text, image, audio.                                     |
| [DeepSeek V3/R1](https://github.com/deepseek-ai/DeepSeek-V3) ⭐ 104,422 \| 🐛 205 \| 🌐 Python \| 📅 2025-08-28 | DeepSeek  | 671B MoE  | 68x cheaper. Strong reasoning. V4 Lite in preview.                         |
| [Gemma 4](https://github.com/google-deepmind/gemma) ⭐ 5,699 \| 🐛 321 \| 🌐 Python \| 📅 2026-08-26            | Google    | 2B-31B    | ⭐ **NEW (Apr 2026)** Consumer/IoT optimized. E2B, E4B variants.            |
...
| Tool                                                                                                         | Description                                                                      |
| ------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------- |
| [Guardrails AI](https://github.com/guardrails-ai/guardrails) ⭐ 7,327 \| 🐛 88 \| 🌐 Python \| 📅 2026-08-27  | Structural, type, quality guarantees for LLM outputs.                            |
| [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) ⭐ 7,023 \| 🐛 207 \| 🌐 Python \| 📅 2026-08-27 | NVIDIA. Programmable conversation guardrails.                                    |
...
| [PentestGPT](https://github.com/GreyDGL/PentestGPT) ⭐ 15,107 \| 🐛 70 \| 🌐 Python \| 📅 2026-07-14         | GPT-powered pentesting. Automated reasoning.                                                                                |
...
* [Microsoft GenAI for Beginners](https://github.com/microsoft/generative-ai-for-beginners) ⭐ 118,666 | 🐛 28 | 🌐 Jupyter Notebook | 📅 2026-08-27 - 21-lesson course
* [OpenAI Cookbook](https://github.com/openai/openai-cookbook) ⭐ 75,583 | 🐛 294 | 🌐 Jupyter Notebook | 📅 2026-08-27 - Practical API guides
* [Anthropic Cookbook](https://github.com/anthropics/anthropic-cookbook) ⭐ 52,211 | 🐛 316 | 🌐 Jupyter Notebook | 📅 2026-08-19 - Claude agent recipes
