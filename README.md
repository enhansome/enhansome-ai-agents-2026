...
[![Stars](https://img.shields.io/github/stars/caramaschiHG/awesome-ai-agents-2026?style=flat-square\&color=yellow)](https://github.com/caramaschiHG/awesome-ai-agents-2026/stargazers) ⭐ 1,593 | 🐛 356 | 📅 2026-06-10
...
* [GNAP](https://github.com/farol-team/gnap) ⭐ 79 | 🐛 2 | 📅 2026-03-17 — Git-Native Agent Protocol: coordinate AI agent teams with 4 JSON files in a git repo. No server, no database. Any agent that can git push can participate. MIT licensed.
...
| [OpenAI Codex CLI](https://github.com/openai/codex) ⭐ 106,470 \| 🐛 12,863 \| 🌐 Rust \| 📅 2026-08-17          | OpenAI terminal agent. Agents SDK. Multi-agent.                                                                             | ChatGPT sub            |
| [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,540 \| 🐛 804 \| 🌐 TypeScript \| 📅 2026-08-17 | ⭐ **NEW (Apr 2026)** Google's official open-source terminal agent. ReAct loop. MCP support. 1M context. Apache 2.0.         | Free w/ Google account |
| [Aider](https://github.com/paul-gauthier/aider) ⭐ 48,282 \| 🐛 1,816 \| 🌐 Python \| 📅 2026-05-22              | OSS pair programmer. Git-aware. Any LLM.                                                                                    | Free + API             |
| [Cline](https://github.com/cline/cline) ⭐ 66,347 \| 🐛 1,022 \| 🌐 TypeScript \| 📅 2026-08-17                  | VS Code extension. Full terminal and browser access for Claude/GPT.                                                         | Free + API             |
...
| [Caliber](https://github.com/caliber-ai-org/ai-setup) ⭐ 1,247 \| 🐛 15 \| 🌐 TypeScript \| 📅 2026-07-26        | CLI that fingerprints projects and generates/syncs AI agent configs (CLAUDE.md, .cursor/rules/, AGENTS.md). Scores quality. | Free + API             |
...
| [SWE-Agent](https://github.com/princeton-nlp/SWE-agent) ⭐ 20,070 \| 🐛 76 \| 🌐 Python \| 📅 2026-08-10     | Princeton. Resolves real GitHub issues autonomously.                                   | Free (OSS)   |
| [OpenHands](https://github.com/All-Hands-AI/OpenHands) ⭐ 84,309 \| 🐛 510 \| 🌐 TypeScript \| 📅 2026-08-17 | OSS autonomous software engineer (ex-OpenDevin).                                       | Free (OSS)   |
...
| [PR-Agent](https://github.com/Codium-ai/pr-agent) ⭐ 12,583 \| 🐛 149 \| 🌐 Python \| 📅 2026-08-16 | OSS AI PR reviewer. Auto-describe, review, improve. | Free (OSS)        |
...
| [Dyad](https://github.com/dyad-sh/dyad) ⭐ 21,264 \| 🐛 287 \| 🌐 TypeScript \| 📅 2026-08-17 | OSS. Local-first. No-code app builder.     | Free (OSS)    |
...
| ------------------------------------------------------------------------------------------------------------------- | ---------- | --------------------------------------------------------------------------- |
| [LangChain](https://github.com/langchain-ai/langchain) ⭐ 144,409 \| 🐛 416 \| 🌐 Python \| 📅 2026-08-17            | Py/JS      | Most adopted. Modular architecture, memory, tools.                          |
| [LangGraph](https://github.com/langchain-ai/langgraph) ⭐ 39,869 \| 🐛 698 \| 🌐 Python \| 📅 2026-08-16             | Py/JS      | Graph-based orchestration. Stateful directed graphs.                        |
| [LlamaIndex](https://github.com/run-llama/llama_index) ⭐ 51,704 \| 🐛 620 \| 🌐 Python \| 📅 2026-08-17             | Py/JS      | Data-focused. Best for RAG agents.                                          |
| [Haystack](https://github.com/deepset-ai/haystack) ⭐ 26,234 \| 🐛 103 \| 🌐 Python \| 📅 2026-08-17                 | Py         | Pipeline-based. Search and retrieval.                                       |
| [Semantic Kernel](https://github.com/microsoft/semantic-kernel) ⭐ 28,459 \| 🐛 244 \| 🌐 C# \| 📅 2026-08-11        | C#/Py/Java | Microsoft enterprise. Azure integration.                                    |
| [Pydantic AI](https://github.com/pydantic/pydantic-ai) ⭐ 19,353 \| 🐛 713 \| 🌐 Python \| 📅 2026-08-17             | Py         | Type-safe. Clean Pythonic API. Production-ready.                            |
| [DSPy](https://github.com/stanfordnlp/dspy) ⭐ 37,342 \| 🐛 654 \| 🌐 Python \| 📅 2026-08-17                        | Py         | Stanford. Programming not prompting. Auto-optimizes.                        |
| [Mastra](https://github.com/mastra-ai/mastra) ⭐ 27,249 \| 🐛 478 \| 🌐 TypeScript \| 📅 2026-08-17                  | TS         | TypeScript-first. Observational Memory. Apache 2.0.                         |
| [Anthropic SDK](https://github.com/anthropics/anthropic-sdk-python) ⭐ 3,827 \| 🐛 186 \| 🌐 Python \| 📅 2026-08-15 | Py/TS      | Official Claude SDK. Tool use, computer control, streaming.                 |
| [Google ADK](https://github.com/google/adk-python) ⭐ 21,161 \| 🐛 569 \| 🌐 Python \| 📅 2026-08-17                 | Py         | ⭐ Google's Agent Development Kit. Native Gemini. Multi-agent orchestration. |

### Multi-Agent Orchestration

| Framework                                                                                                           | Lang               | Description                                                                                                            |
| ------------------------------------------------------------------------------------------------------------------- | ------------------ | ---------------------------------------------------------------------------------------------------------------------- |
| [AutoGen](https://github.com/microsoft/autogen) ⭐ 60,471 \| 🐛 995 \| 🌐 Python \| 📅 2026-04-15                    | Py                 | Microsoft multi-agent conversations.                                                                                   |
| [CrewAI](https://github.com/crewAIInc/crewAI) ⭐ 57,209 \| 🐛 811 \| 🌐 Python \| 📅 2026-08-17                      | Py                 | Role-based crew members with goals and tools. Used by 60%+ Fortune 500.                                                |
| [MetaGPT](https://github.com/geekan/MetaGPT) ⭐ 69,864 \| 🐛 129 \| 🌐 Python \| 📅 2026-01-21                       | Py                 | PM, architect, engineer roles. Software company sim.                                                                   |
...
| [OpenAI Agents SDK](https://github.com/openai/openai-agents-python) ⭐ 28,721 \| 🐛 24 \| 🌐 Python \| 📅 2026-08-17 | Py                 | Official. Multi-step agents with handoffs.                                                                             |
| [Strands Agents](https://github.com/strands-agents/sdk-python) ⭐ 6,931 \| 🐛 674 \| 🌐 Python \| 📅 2026-08-17      | Py                 | AWS-backed. Model-driven tool use.                                                                                     |
| [CAMEL](https://github.com/camel-ai/camel) ⭐ 17,598 \| 🐛 471 \| 🌐 Python \| 📅 2026-08-14                         | Py                 | Role-based simulation. Collaborative reasoning.                                                                        |
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) ⭐ 186,646 \| 🐛 508 \| 🌐 Python \| 📅 2026-08-17        | Py                 | Pioneer. Now full platform with visual builder.                                                                        |
| [Bernstein](https://github.com/chernistry/bernstein) ⭐ 917 \| 🐛 199 \| 🌐 Python \| 📅 2026-08-17                  | Py                 | Deterministic orchestrator. Parallel coding agents, test-driven verification. Zero LLM tokens on coordination.         |
| [AgentScope](https://github.com/modelscope/agentscope) ⭐ 28,997 \| 🐛 361 \| 🌐 Python \| 📅 2026-08-14             | Py                 | Alibaba multi-agent framework.                                                                                         |
| [MagiC](https://github.com/kienbui1995/magic) ⭐ 0 \| 🐛 11 \| 🌐 HTML \| 📅 2026-08-16                              | Go/Py              | Kubernetes for AI agents. Manages any agent from any framework. Routing, cost control, DAG workflows, circuit breaker. |
| [DeerFlow](https://github.com/bytedance/deer-flow) ⭐ 80,162 \| 🐛 941 \| 🌐 Python \| 📅 2026-08-17                 | Py                 | ByteDance. No.1 GitHub Trending Feb 2026. 25k+ stars.                                                                  |
...
| Framework                                                                                                | Lang | Description                               |
| -------------------------------------------------------------------------------------------------------- | ---- | ----------------------------------------- |
| [Smolagents](https://github.com/huggingface/smolagents) ⭐ 28,842 \| 🐛 774 \| 🌐 Python \| 📅 2026-07-21 | Py   | HuggingFace minimal agents. \~1000 lines. |
| [Agno](https://github.com/agno-agi/agno) ⭐ 41,743 \| 🐛 1,257 \| 🌐 Python \| 📅 2026-08-17              | Py   | Lightweight, model-agnostic.              |
| [Upsonic](https://github.com/upsonic/upsonic) ⭐ 7,941 \| 🐛 30 \| 🌐 Python \| 📅 2026-06-18             | Py   | MCP support. Minimal setup.               |
...
| --------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [OpenClaw Agent Templates](https://github.com/mergisi/awesome-openclaw-agents) ⭐ 3,914 \| 🐛 84 \| 🌐 HTML \| 📅 2026-05-25 | 177 production-ready SOUL.md configs across 24 categories (PM, SEO, DevOps, Writer, Support). Copy-paste ready for [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 386,537 \| 🐛 5,664 \| 🌐 TypeScript \| 📅 2026-08-17. Visual deploy via [CrewClaw](https://crewclaw.com). |
...
| Tool                                                                                                             | Description                                                                                                                                      |
| ---------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Browser Use](https://github.com/browser-use/browser-use) ⭐ 109,505 \| 🐛 359 \| 🌐 Python \| 📅 2026-08-17      | OSS browser agent library. Used by Manus.                                                                                                        |
| [Skyvern](https://github.com/Skyvern-AI/skyvern) ⭐ 22,771 \| 🐛 218 \| 🌐 Python \| 📅 2026-08-17                | Vision-driven. GPT-4V navigation without coded selectors.                                                                                        |
| [Agent S2 (Simular)](https://github.com/simular-ai/Agent-S) ⭐ 12,164 \| 🐛 39 \| 🌐 Python \| 📅 2026-08-01      | OSS GUI automation framework.                                                                                                                    |
...
| [Plasmate](https://github.com/plasmate-labs/plasmate) ⭐ 34 \| 🐛 1 \| 🌐 Rust \| 📅 2026-08-17                   | Headless browser compiling HTML to structured JSON (SOM). 17.5x compression, 13 MCP tools. First browser tool on MCP Registry. Rust, Apache-2.0. |
| [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 36,210 \| 🐛 6 \| 🌐 TypeScript \| 📅 2026-08-12 | MCP server for Playwright + AI agents.                                                                                                           |
| [onUI](https://github.com/onllm-dev/onUI) ⭐ 93 \| 🐛 1 \| 🌐 TypeScript \| 📅 2026-04-28                         | OSS browser extension and MCP server for annotation-first UI pair programming with AI agents. Chrome, Edge, Firefox. Privacy-first, local only.  |
...
| Tool                                                                                                 | Description                                       |
| ---------------------------------------------------------------------------------------------------- | ------------------------------------------------- |
| [LiveKit Agents](https://github.com/livekit/agents) ⭐ 13,037 \| 🐛 763 \| 🌐 Python \| 📅 2026-08-17 | OSS real-time voice/video AI agents.              |
| [Rasa](https://github.com/RasaHQ/rasa) ⭐ 21,296 \| 🐛 153 \| 🌐 Python \| 📅 2026-07-24              | OSS conversational AI. Self-hosted. NLU training. |
| [Pipecat](https://github.com/pipecat-ai/pipecat) ⭐ 14,213 \| 🐛 239 \| 🌐 Python \| 📅 2026-08-17    | OSS voice and multimodal conversational AI.       |
| [Vocode](https://github.com/vocodedev/vocode-python) ⭐ 3,785 \| 🐛 2 \| 🌐 Python \| 📅 2024-11-15   | OSS voice-based LLM agents.                       |
...
| [InkOS](https://github.com/Narcooo/inkos) ⭐ 9,058 \| 🐛 225 \| 🌐 TypeScript \| 📅 2026-08-17 | Autonomous novel-writing CLI agent. Agents collaborate to produce long-form fiction with continuity auditing, anti-AI-slop filtering, and style cloning. | Free / OSS     |
...
| [Wan 2.1](https://github.com/Wan-Video/Wan2.1) ⭐ 16,844 \| 🐛 376 \| 🌐 Python \| 📅 2026-03-05          | Best free OSS video gen. Self-hostable. No limits.                                 | Free (OSS)       |
| [HunyuanVideo](https://github.com/Tencent/HunyuanVideo) ⭐ 12,431 \| 🐛 183 \| 🌐 Python \| 📅 2026-06-29 | Tencent OSS. Consumer GPU. Multi-style.                                            | Free (OSS)       |
| [LTX Video](https://github.com/Lightricks/LTX-Video) ⭐ 10,859 \| 🐛 99 \| 🌐 Python \| 📅 2026-01-05     | OSS. Licensed data. Clear commercial terms.                                        | Free (OSS)       |
...
| [Meta AudioCraft](https://github.com/facebookresearch/audiocraft) ⭐ 23,562 \| 🐛 394 \| 🌐 Jupyter Notebook \| 📅 2026-03-03 | OSS. MusicGen + AudioGen.                                  | Free (OSS)     |
...
| Agent                                                                                                             | Description                                                                                                                              | Pricing        |
| ----------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- | -------------- |
| [n8n](https://github.com/n8n-io/n8n) ⭐ 200,968 \| 🐛 1,307 \| 🌐 TypeScript \| 📅 2026-08-17                      | OSS workflow automation with AI agent nodes. Visual + code.                                                                              | Free / Cloud   |
...
| [Activepieces](https://github.com/activepieces/activepieces) ⭐ 23,849 \| 🐛 469 \| 🌐 TypeScript \| 📅 2026-08-17 | OSS Zapier alternative with AI.                                                                                                          | Free (OSS)     |
| [Temporal](https://github.com/temporalio/temporal) ⭐ 22,368 \| 🐛 895 \| 🌐 Go \| 📅 2026-08-17                   | Durable execution for long-running agent workflows.                                                                                      | Free / Cloud   |
| [Mission Control](https://github.com/MeisnerDan/mission-control) ⭐ 631 \| 🐛 16 \| 🌐 TypeScript \| 📅 2026-04-01 | Cockpit for the agentic era — manage AI agent swarms with autonomous daemon, Field Ops for real-world execution, and approval workflows. | Free (OSS)     |

### No-Code Agent Builders

| Agent                                                                                                 | Description                                                                                                                                            | Pricing      |
| ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------ |
| [Dify](https://github.com/langgenius/dify) ⭐ 152,707 \| 🐛 1,005 \| 🌐 TypeScript \| 📅 2026-08-17    | OSS LLMOps. Visual agent builder. RAG. 130k+ stars.                                                                                                    | Free / Cloud |
| [Flowise](https://github.com/FlowiseAI/Flowise) ⚠️ Archived                                           | OSS drag-and-drop LLM agent builder.                                                                                                                   | Free (OSS)   |
| [Langflow](https://github.com/langflow-ai/langflow) ⭐ 153,361 \| 🐛 966 \| 🌐 Python \| 📅 2026-08-17 | Visual multi-agent and RAG builder.                                                                                                                    | Free / Cloud |
...
| [FastAgency](https://github.com/airtai/fastagency) ⭐ 546 \| 🐛 80 \| 🌐 Python \| 📅 2026-02-23       | Deploy multi-agent workflows as APIs.                                                                                                                  | Free (OSS)   |
...
| [DeerFlow](https://github.com/bytedance/deer-flow) ⭐ 80,162 \| 🐛 941 \| 🌐 Python \| 📅 2026-08-17              | ByteDance OSS. Planning, tools, memory, execution.            | Free (OSS)      |
| [GPT Researcher](https://github.com/assafelovic/gpt-researcher) ⭐ 29,015 \| 🐛 176 \| 🌐 Python \| 📅 2026-07-18 | OSS autonomous comprehensive research.                        | Free (OSS)      |
| [STORM](https://github.com/stanford-oval/storm) ⭐ 31,039 \| 🐛 108 \| 🌐 Python \| 📅 2025-09-30                 | Stanford. Writes Wikipedia-like articles from scratch.        | Free (OSS)      |
...
| [PandasAI](https://github.com/Sinaptik-AI/pandas-ai) ⭐ 23,745 \| 🐛 22 \| 🌐 Python \| 📅 2025-10-28 | Chat with your data. NL to Pandas/SQL.                                                                                                                                                            | Free (OSS)  |
...
| Tool                                                                                                                                                                                                                                                                                                                                                                    | Description                                                                             |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| [RAGFlow](https://github.com/infiniflow/ragflow) ⭐ 88,677 \| 🐛 1,794 \| 🌐 Go \| 📅 2026-08-17                                                                                                                                                                                                                                                                         | OSS RAG engine with agent capabilities.                                                 |
| [Lorg](https://github.com/LorgAI/lorg-mcp-server) ⭐ 4 \| 🐛 2 \| 🌐 JavaScript \| 📅 2026-07-13 — Permanent intelligence archive for AI agents. Structured contributions (prompts, workflows, insights, patterns) pass an automated quality gate and are hash-chained. Trust scores are cryptographically backed and publicly auditable. Works with Claude and ChatGPT. |                                                                                         |
| [Pathway](https://github.com/pathwaycom/pathway) ⭐ 62,439 \| 🐛 35 \| 🌐 Python \| 📅 2026-08-17                                                                                                                                                                                                                                                                        | Live data RAG. Real-time streaming. 50k+ stars.                                         |
| [Mem0](https://github.com/mem0ai/mem0) ⭐ 63,450 \| 🐛 681 \| 🌐 Python \| 📅 2026-08-15                                                                                                                                                                                                                                                                                 | Memory layer for agents. Long-term across sessions.                                     |
...
| [Chroma](https://github.com/chroma-core/chroma) ⭐ 29,077 \| 🐛 801 \| 🌐 Rust \| 📅 2026-08-17                                                                                                                                                                                                                                                                          | OSS embedding database. Fastest way to build RAG.                                       |
| [Weaviate](https://github.com/weaviate/weaviate) ⭐ 16,734 \| 🐛 690 \| 🌐 Go \| 📅 2026-08-17                                                                                                                                                                                                                                                                           | OSS vector DB. GraphQL. Multi-modal search.                                             |
| [Qdrant](https://github.com/qdrant/qdrant) ⭐ 34,029 \| 🐛 694 \| 🌐 Rust \| 📅 2026-08-17                                                                                                                                                                                                                                                                               | High-performance vector DB in Rust.                                                     |
| [Milvus](https://github.com/milvus-io/milvus) ⭐ 45,666 \| 🐛 1,281 \| 🌐 Go \| 📅 2026-08-17                                                                                                                                                                                                                                                                            | Cloud-native vector DB. Billion-scale.                                                  |
...
| Tool                                                                                                 | Description                                                       |
| ---------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| [Ollama](https://github.com/ollama/ollama) ⭐ 178,774 \| 🐛 3,731 \| 🌐 Go \| 📅 2026-08-16           | Run LLMs locally. 162k+ stars. Dead simple CLI.                   |
| [llama.cpp](https://github.com/ggml-org/llama.cpp) ⭐ 124,351 \| 🐛 2,113 \| 🌐 C++ \| 📅 2026-08-17  | C/C++ inference. CPU, GPU, Apple Silicon. Foundation of local AI. |
| [vLLM](https://github.com/vllm-project/vllm) ⭐ 89,272 \| 🐛 6,667 \| 🌐 Python \| 📅 2026-08-17      | High-throughput serving. PagedAttention. Production-grade.        |
| [LM Studio](https://lmstudio.ai)                                                                     | Desktop app for local LLMs. Beautiful UI. All platforms.          |
| [Jan](https://github.com/janhq/jan) ⭐ 44,031 \| 🐛 449 \| 🌐 TypeScript \| 📅 2026-08-17             | OSS ChatGPT alternative. 100% offline.                            |
| [LocalAI](https://github.com/mudler/LocalAI) ⭐ 48,529 \| 🐛 166 \| 🌐 Go \| 📅 2026-08-17            | Drop-in OpenAI API replacement. No GPU required.                  |
...
| [GPT4All](https://github.com/nomic-ai/gpt4all) ⭐ 77,405 \| 🐛 773 \| 🌐 C++ \| 📅 2025-05-27         | OSS local chat. Consumer hardware.                                |
| [Llamafile](https://github.com/Mozilla-Ocho/llamafile) ⭐ 25,618 \| 🐛 212 \| 🌐 C++ \| 📅 2026-08-17 | LLMs as single files. Zero setup. Mozilla.                        |

### Self-Hosted Agents and UIs

| Tool                                                                                                               | Description                                                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Open WebUI](https://github.com/open-webui/open-webui) ⭐ 149,031 \| 🐛 355 \| 🌐 Python \| 📅 2026-08-17           | Self-hosted ChatGPT UI. Access control. Extensions.                                                                                                                                                            |
| [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 386,537 \| 🐛 5,664 \| 🌐 TypeScript \| 📅 2026-08-17           | Fastest-growing GitHub repo ever (9k to 188k stars in 60 days). Self-hosted agent across WhatsApp, Telegram, Slack, Discord, Signal. 5,700+ community skills.                                                  |
...
| [LibreChat](https://github.com/danny-avila/LibreChat) ⭐ 42,147 \| 🐛 694 \| 🌐 TypeScript \| 📅 2026-08-17         | Self-hosted multi-model chat. All major providers.                                                                                                                                                             |
| [LobeChat](https://github.com/lobehub/lobe-chat) ⭐ 81,777 \| 🐛 751 \| 🌐 TypeScript \| 📅 2026-08-17              | OSS ChatGPT/Gemini UI. Plugin system. Multi-modal.                                                                                                                                                             |
...
| [Anything LLM](https://github.com/Mintplex-Labs/anything-llm) ⭐ 64,829 \| 🐛 329 \| 🌐 JavaScript \| 📅 2026-08-13 | All-in-one AI app. RAG, agents. Desktop + Docker.                                                                                                                                                              |
| [DB-GPT](https://github.com/eosphoros-ai/DB-GPT) ⭐ 19,738 \| 🐛 426 \| 🌐 Python \| 📅 2026-08-17                  | Data interaction with local LLM. 100% private.                                                                                                                                                                 |
...
| [Cursor AI Automated Team](https://github.com/joinwell52-AI/joinwell52) ⭐ 4 \| 🐛 3 \| 🌐 JavaScript \| 📅 2026-08-17 | 4-role AI team (PM+DEV+OPS+QA) in Cursor IDE. File-based task routing, auto patrol bot. 87 person-days in 17 days.                                | Free / OSS        |
...
| [A2A (Agent-to-Agent)](https://github.com/google/A2A) ⭐ 25,378 \| 🐛 228 \| 🌐 Shell \| 📅 2026-08-17      | Google protocol for inter-agent communication. Horizontal agent collaboration.                                                                     |
...
| [OpenAPI](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,157 \| 🐛 121 \| 🌐 Markdown \| 📅 2026-08-13 | Industry-standard API spec. Foundation for agent tools.                                                                                            |
...
| Tool                                                                                            | Description                                                                                                                                                                            |
| ----------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Entroly](https://github.com/juyterman1000/entroly) ⭐ 437 \| 🐛 2 \| 🌐 Python \| 📅 2026-08-17 | Context engineering engine. 100% codebase visibility with 78% fewer tokens. Knapsack-optimal selection, SimHash dedup, RL from response quality. Rust engine, <10ms. MCP + HTTP proxy. |

### Tracing and Monitoring

| Tool                                                                                                     | Description                                                                                                                          |
| -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| [Langfuse](https://github.com/langfuse/langfuse) ⭐ 33,259 \| 🐛 783 \| 🌐 TypeScript \| 📅 2026-08-17    | OSS LLM observability. Traces, evals, prompts.                                                                                       |
...
| [Arize Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,088 \| 🐛 923 \| 🌐 Python \| 📅 2026-08-17    | OSS AI observability. Traces, evals, embeddings.                                                                                     |
| [Helicone](https://github.com/Helicone/helicone) ⭐ 6,075 \| 🐛 172 \| 🌐 TypeScript \| 📅 2026-08-16     | OSS LLM observability. One-line integration.                                                                                         |
...
| ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| [SWE-bench](https://github.com/princeton-nlp/SWE-bench) ⭐ 5,654 \| 🐛 5 \| 🌐 Python \| 📅 2026-08-17 | Industry standard for coding agents. Top: 80.9% (Claude Opus 4.6). |
| [AgentBench](https://github.com/THUDM/AgentBench) ⭐ 3,675 \| 🐛 75 \| 🌐 Python \| 📅 2026-02-08      | 8-environment LLM agent benchmark.                                 |
...
| [WebArena](https://github.com/web-arena-x/webarena) ⭐ 1,579 \| 🐛 100 \| 🌐 Python \| 📅 2025-11-26   | Web agent benchmark. Real websites.                                |
...
| [Qwen3.6-Plus](https://github.com/QwenLM/Qwen3) ⭐ 27,522 \| 🐛 65 \| 🌐 Python \| 📅 2026-01-09                | Alibaba   | Various   | ⭐ **NEW (Apr 2026)** Agentic focus. 1M ctx. Repo-level coding. MCP-native. |
| [Qwen3.5-Omni](https://github.com/QwenLM/Qwen3) ⭐ 27,522 \| 🐛 65 \| 🌐 Python \| 📅 2026-01-09                | Alibaba   | 397B MoE  | Native multimodal. Text, image, audio.                                     |
| [DeepSeek V3/R1](https://github.com/deepseek-ai/DeepSeek-V3) ⭐ 104,321 \| 🐛 207 \| 🌐 Python \| 📅 2025-08-28 | DeepSeek  | 671B MoE  | 68x cheaper. Strong reasoning. V4 Lite in preview.                         |
| [Gemma 4](https://github.com/google-deepmind/gemma) ⭐ 5,663 \| 🐛 316 \| 🌐 Python \| 📅 2026-08-10            | Google    | 2B-31B    | ⭐ **NEW (Apr 2026)** Consumer/IoT optimized. E2B, E4B variants.            |
...
| Tool                                                                                                         | Description                                                                      |
| ------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------- |
| [Guardrails AI](https://github.com/guardrails-ai/guardrails) ⭐ 7,295 \| 🐛 87 \| 🌐 Python \| 📅 2026-08-14  | Structural, type, quality guarantees for LLM outputs.                            |
| [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) ⭐ 6,967 \| 🐛 218 \| 🌐 Python \| 📅 2026-08-17 | NVIDIA. Programmable conversation guardrails.                                    |
...
| Agent                                                                                                       | Description                                                                                                                 |
| ----------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| [CAI](https://github.com/aliasrobotics/CAI) ⭐ 9,751 \| 🐛 15 \| 🌐 Python \| 📅 2026-07-14                  | AI pentesting, vuln discovery, red teaming. HITL.                                                                           |
| [YAWNING TITAN](https://github.com/dstl/YAWNING-TITAN) ⚠️ Archived                                          | Graph-based cybersecurity simulation.                                                                                       |
| [PentestGPT](https://github.com/GreyDGL/PentestGPT) ⭐ 14,915 \| 🐛 66 \| 🌐 Python \| 📅 2026-07-14         | GPT-powered pentesting. Automated reasoning.                                                                                |
...
* [Microsoft GenAI for Beginners](https://github.com/microsoft/generative-ai-for-beginners) ⭐ 117,935 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2026-08-13 - 21-lesson course
* [OpenAI Cookbook](https://github.com/openai/openai-cookbook) ⭐ 75,290 | 🐛 244 | 🌐 Jupyter Notebook | 📅 2026-08-17 - Practical API guides
* [Anthropic Cookbook](https://github.com/anthropics/anthropic-cookbook) ⭐ 51,708 | 🐛 310 | 🌐 Jupyter Notebook | 📅 2026-08-14 - Claude agent recipes
