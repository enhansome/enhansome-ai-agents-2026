...
[![Stars](https://img.shields.io/github/stars/caramaschiHG/awesome-ai-agents-2026?style=flat-square\&color=yellow)](https://github.com/caramaschiHG/awesome-ai-agents-2026/stargazers) ⭐ 1,742 | 🐛 375 | 📅 2026-06-10
...
| [OpenAI Codex CLI](https://github.com/openai/codex) ⭐ 120,962 \| 🐛 14,928 \| 🌐 Rust \| 📅 2026-09-02          | OpenAI terminal agent. Agents SDK. Multi-agent.                                                                             | ChatGPT sub            |
| [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,773 \| 🐛 860 \| 🌐 TypeScript \| 📅 2026-09-02 | ⭐ **NEW (Apr 2026)** Google's official open-source terminal agent. ReAct loop. MCP support. 1M context. Apache 2.0.         | Free w/ Google account |
| [Aider](https://github.com/paul-gauthier/aider) ⭐ 48,677 \| 🐛 1,844 \| 🌐 Python \| 📅 2026-05-22              | OSS pair programmer. Git-aware. Any LLM.                                                                                    | Free + API             |
| [Cline](https://github.com/cline/cline) ⭐ 67,359 \| 🐛 1,182 \| 🌐 TypeScript \| 📅 2026-09-02                  | VS Code extension. Full terminal and browser access for Claude/GPT.                                                         | Free + API             |
...
| [SWE-Agent](https://github.com/princeton-nlp/SWE-agent) ⭐ 20,197 \| 🐛 89 \| 🌐 Python \| 📅 2026-08-31     | Princeton. Resolves real GitHub issues autonomously.                                   | Free (OSS)   |
| [OpenHands](https://github.com/All-Hands-AI/OpenHands) ⭐ 85,967 \| 🐛 638 \| 🌐 TypeScript \| 📅 2026-09-02 | OSS autonomous software engineer (ex-OpenDevin).                                       | Free (OSS)   |
...
| [PR-Agent](https://github.com/Codium-ai/pr-agent) ⭐ 12,821 \| 🐛 85 \| 🌐 Python \| 📅 2026-09-02 | OSS AI PR reviewer. Auto-describe, review, improve. | Free (OSS)        |
...
| [Dyad](https://github.com/dyad-sh/dyad) ⭐ 21,369 \| 🐛 282 \| 🌐 TypeScript \| 📅 2026-09-02 | OSS. Local-first. No-code app builder.     | Free (OSS)    |
...
| ------------------------------------------------------------------------------------------------------------------- | ---------- | --------------------------------------------------------------------------- |
| [LangChain](https://github.com/langchain-ai/langchain) ⭐ 145,522 \| 🐛 441 \| 🌐 Python \| 📅 2026-09-02            | Py/JS      | Most adopted. Modular architecture, memory, tools.                          |
| [LangGraph](https://github.com/langchain-ai/langgraph) ⭐ 40,940 \| 🐛 740 \| 🌐 Python \| 📅 2026-09-02             | Py/JS      | Graph-based orchestration. Stateful directed graphs.                        |
| [LlamaIndex](https://github.com/run-llama/llama_index) ⭐ 51,983 \| 🐛 693 \| 🌐 Python \| 📅 2026-09-02             | Py/JS      | Data-focused. Best for RAG agents.                                          |
| [Haystack](https://github.com/deepset-ai/haystack) ⭐ 26,396 \| 🐛 103 \| 🌐 Python \| 📅 2026-09-02                 | Py         | Pipeline-based. Search and retrieval.                                       |
| [Semantic Kernel](https://github.com/microsoft/semantic-kernel) ⭐ 28,522 \| 🐛 271 \| 🌐 C# \| 📅 2026-09-02        | C#/Py/Java | Microsoft enterprise. Azure integration.                                    |
| [Pydantic AI](https://github.com/pydantic/pydantic-ai) ⭐ 19,676 \| 🐛 789 \| 🌐 Python \| 📅 2026-09-02             | Py         | Type-safe. Clean Pythonic API. Production-ready.                            |
| [DSPy](https://github.com/stanfordnlp/dspy) ⭐ 37,729 \| 🐛 643 \| 🌐 Python \| 📅 2026-09-01                        | Py         | Stanford. Programming not prompting. Auto-optimizes.                        |
| [Mastra](https://github.com/mastra-ai/mastra) ⭐ 27,650 \| 🐛 522 \| 🌐 TypeScript \| 📅 2026-09-02                  | TS         | TypeScript-first. Observational Memory. Apache 2.0.                         |
| [Anthropic SDK](https://github.com/anthropics/anthropic-sdk-python) ⭐ 3,879 \| 🐛 157 \| 🌐 Python \| 📅 2026-09-02 | Py/TS      | Official Claude SDK. Tool use, computer control, streaming.                 |
| [Google ADK](https://github.com/google/adk-python) ⭐ 21,377 \| 🐛 527 \| 🌐 Python \| 📅 2026-09-02                 | Py         | ⭐ Google's Agent Development Kit. Native Gemini. Multi-agent orchestration. |

### Multi-Agent Orchestration

| Framework                                                                                                           | Lang               | Description                                                                                                            |
| ------------------------------------------------------------------------------------------------------------------- | ------------------ | ---------------------------------------------------------------------------------------------------------------------- |
| [AutoGen](https://github.com/microsoft/autogen) ⭐ 60,764 \| 🐛 1,030 \| 🌐 Python \| 📅 2026-04-15                  | Py                 | Microsoft multi-agent conversations.                                                                                   |
| [CrewAI](https://github.com/crewAIInc/crewAI) ⭐ 58,007 \| 🐛 705 \| 🌐 Python \| 📅 2026-09-02                      | Py                 | Role-based crew members with goals and tools. Used by 60%+ Fortune 500.                                                |
| [MetaGPT](https://github.com/geekan/MetaGPT) ⭐ 70,178 \| 🐛 132 \| 🌐 Python \| 📅 2026-01-21                       | Py                 | PM, architect, engineer roles. Software company sim.                                                                   |
...
| [OpenAI Agents SDK](https://github.com/openai/openai-agents-python) ⭐ 29,145 \| 🐛 71 \| 🌐 Python \| 📅 2026-09-02 | Py                 | Official. Multi-step agents with handoffs.                                                                             |
| [Strands Agents](https://github.com/strands-agents/sdk-python) ⭐ 7,124 \| 🐛 695 \| 🌐 Python \| 📅 2026-09-02      | Py                 | AWS-backed. Model-driven tool use.                                                                                     |
| [CAMEL](https://github.com/camel-ai/camel) ⭐ 17,660 \| 🐛 490 \| 🌐 Python \| 📅 2026-08-31                         | Py                 | Role-based simulation. Collaborative reasoning.                                                                        |
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) ⭐ 187,081 \| 🐛 531 \| 🌐 Python \| 📅 2026-09-02        | Py                 | Pioneer. Now full platform with visual builder.                                                                        |
| [Bernstein](https://github.com/chernistry/bernstein) ⭐ 1,074 \| 🐛 311 \| 🌐 Python \| 📅 2026-09-02                | Py                 | Deterministic orchestrator. Parallel coding agents, test-driven verification. Zero LLM tokens on coordination.         |
| [AgentScope](https://github.com/modelscope/agentscope) ⭐ 30,441 \| 🐛 353 \| 🌐 Python \| 📅 2026-09-01             | Py                 | Alibaba multi-agent framework.                                                                                         |
...
| [DeerFlow](https://github.com/bytedance/deer-flow) ⭐ 81,271 \| 🐛 872 \| 🌐 Python \| 📅 2026-09-02                 | Py                 | ByteDance. No.1 GitHub Trending Feb 2026. 25k+ stars.                                                                  |
...
| Framework                                                                                                | Lang | Description                               |
| -------------------------------------------------------------------------------------------------------- | ---- | ----------------------------------------- |
| [Smolagents](https://github.com/huggingface/smolagents) ⭐ 29,125 \| 🐛 757 \| 🌐 Python \| 📅 2026-08-25 | Py   | HuggingFace minimal agents. \~1000 lines. |
| [Agno](https://github.com/agno-agi/agno) ⭐ 42,015 \| 🐛 1,310 \| 🌐 Python \| 📅 2026-09-02              | Py   | Lightweight, model-agnostic.              |
...
| --------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [OpenClaw Agent Templates](https://github.com/mergisi/awesome-openclaw-agents) ⭐ 3,949 \| 🐛 88 \| 🌐 HTML \| 📅 2026-05-25 | 177 production-ready SOUL.md configs across 24 categories (PM, SEO, DevOps, Writer, Support). Copy-paste ready for [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 388,650 \| 🐛 6,136 \| 🌐 TypeScript \| 📅 2026-09-02. Visual deploy via [CrewClaw](https://crewclaw.com). |
...
| Tool                                                                                                             | Description                                                                                                                                      |
| ---------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Browser Use](https://github.com/browser-use/browser-use) ⭐ 112,076 \| 🐛 401 \| 🌐 Python \| 📅 2026-09-02      | OSS browser agent library. Used by Manus.                                                                                                        |
| [Skyvern](https://github.com/Skyvern-AI/skyvern) ⭐ 22,914 \| 🐛 216 \| 🌐 Python \| 📅 2026-09-02                | Vision-driven. GPT-4V navigation without coded selectors.                                                                                        |
| [Agent S2 (Simular)](https://github.com/simular-ai/Agent-S) ⭐ 12,218 \| 🐛 43 \| 🌐 Python \| 📅 2026-08-01      | OSS GUI automation framework.                                                                                                                    |
...
| [Plasmate](https://github.com/plasmate-labs/plasmate) ⭐ 36 \| 🐛 1 \| 🌐 Rust \| 📅 2026-09-02                   | Headless browser compiling HTML to structured JSON (SOM). 17.5x compression, 13 MCP tools. First browser tool on MCP Registry. Rust, Apache-2.0. |
| [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 36,739 \| 🐛 2 \| 🌐 TypeScript \| 📅 2026-09-01 | MCP server for Playwright + AI agents.                                                                                                           |
...
| Tool                                                                                                 | Description                                       |
| ---------------------------------------------------------------------------------------------------- | ------------------------------------------------- |
| [LiveKit Agents](https://github.com/livekit/agents) ⭐ 13,965 \| 🐛 776 \| 🌐 Python \| 📅 2026-09-02 | OSS real-time voice/video AI agents.              |
| [Rasa](https://github.com/RasaHQ/rasa) ⭐ 21,308 \| 🐛 153 \| 🌐 Python \| 📅 2026-07-24              | OSS conversational AI. Self-hosted. NLU training. |
| [Pipecat](https://github.com/pipecat-ai/pipecat) ⭐ 15,143 \| 🐛 313 \| 🌐 Python \| 📅 2026-09-02    | OSS voice and multimodal conversational AI.       |
...
| [InkOS](https://github.com/Narcooo/inkos) ⭐ 9,400 \| 🐛 232 \| 🌐 TypeScript \| 📅 2026-08-25 | Autonomous novel-writing CLI agent. Agents collaborate to produce long-form fiction with continuity auditing, anti-AI-slop filtering, and style cloning. | Free / OSS     |
...
| [Wan 2.1](https://github.com/Wan-Video/Wan2.1) ⭐ 16,928 \| 🐛 380 \| 🌐 Python \| 📅 2026-03-05          | Best free OSS video gen. Self-hostable. No limits.                                 | Free (OSS)       |
...
| [LTX Video](https://github.com/Lightricks/LTX-Video) ⭐ 10,926 \| 🐛 99 \| 🌐 Python \| 📅 2026-01-05     | OSS. Licensed data. Clear commercial terms.                                        | Free (OSS)       |
...
| Agent                                                                                                             | Description                                                                                                                              | Pricing        |
| ----------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- | -------------- |
| [n8n](https://github.com/n8n-io/n8n) ⭐ 203,160 \| 🐛 1,146 \| 🌐 TypeScript \| 📅 2026-09-02                      | OSS workflow automation with AI agent nodes. Visual + code.                                                                              | Free / Cloud   |
...
| [Activepieces](https://github.com/activepieces/activepieces) ⭐ 24,197 \| 🐛 521 \| 🌐 TypeScript \| 📅 2026-09-02 | OSS Zapier alternative with AI.                                                                                                          | Free (OSS)     |
| [Temporal](https://github.com/temporalio/temporal) ⭐ 22,790 \| 🐛 933 \| 🌐 Go \| 📅 2026-09-02                   | Durable execution for long-running agent workflows.                                                                                      | Free / Cloud   |
| [Mission Control](https://github.com/MeisnerDan/mission-control) ⭐ 940 \| 🐛 17 \| 🌐 TypeScript \| 📅 2026-04-01 | Cockpit for the agentic era — manage AI agent swarms with autonomous daemon, Field Ops for real-world execution, and approval workflows. | Free (OSS)     |

### No-Code Agent Builders

| Agent                                                                                                   | Description                                                                                                                                            | Pricing      |
| ------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------ |
| [Dify](https://github.com/langgenius/dify) ⭐ 154,246 \| 🐛 1,041 \| 🌐 TypeScript \| 📅 2026-09-02      | OSS LLMOps. Visual agent builder. RAG. 130k+ stars.                                                                                                    | Free / Cloud |
| [Flowise](https://github.com/FlowiseAI/Flowise) ⚠️ Archived                                             | OSS drag-and-drop LLM agent builder.                                                                                                                   | Free (OSS)   |
| [Langflow](https://github.com/langflow-ai/langflow) ⭐ 154,113 \| 🐛 1,023 \| 🌐 Python \| 📅 2026-09-02 | Visual multi-agent and RAG builder.                                                                                                                    | Free / Cloud |
...
| [DeerFlow](https://github.com/bytedance/deer-flow) ⭐ 81,271 \| 🐛 872 \| 🌐 Python \| 📅 2026-09-02             | ByteDance OSS. Planning, tools, memory, execution.            | Free (OSS)      |
| [GPT Researcher](https://github.com/assafelovic/gpt-researcher) ⭐ 29,261 \| 🐛 69 \| 🌐 Python \| 📅 2026-08-27 | OSS autonomous comprehensive research.                        | Free (OSS)      |
| [STORM](https://github.com/stanford-oval/storm) ⭐ 31,206 \| 🐛 108 \| 🌐 Python \| 📅 2025-09-30                | Stanford. Writes Wikipedia-like articles from scratch.        | Free (OSS)      |
...
| Tool                                                                                                                                                                                                                                                                                                                                                                    | Description                                                                             |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| [RAGFlow](https://github.com/infiniflow/ragflow) ⭐ 89,918 \| 🐛 1,621 \| 🌐 Go \| 📅 2026-09-02                                                                                                                                                                                                                                                                         | OSS RAG engine with agent capabilities.                                                 |
...
| [Pathway](https://github.com/pathwaycom/pathway) ⭐ 62,348 \| 🐛 35 \| 🌐 Python \| 📅 2026-09-02                                                                                                                                                                                                                                                                        | Live data RAG. Real-time streaming. 50k+ stars.                                         |
| [Mem0](https://github.com/mem0ai/mem0) ⭐ 64,590 \| 🐛 719 \| 🌐 Python \| 📅 2026-09-02                                                                                                                                                                                                                                                                                 | Memory layer for agents. Long-term across sessions.                                     |
...
| [Chroma](https://github.com/chroma-core/chroma) ⭐ 29,205 \| 🐛 824 \| 🌐 Rust \| 📅 2026-09-02                                                                                                                                                                                                                                                                          | OSS embedding database. Fastest way to build RAG.                                       |
| [Weaviate](https://github.com/weaviate/weaviate) ⭐ 16,781 \| 🐛 717 \| 🌐 Go \| 📅 2026-09-02                                                                                                                                                                                                                                                                           | OSS vector DB. GraphQL. Multi-modal search.                                             |
| [Qdrant](https://github.com/qdrant/qdrant) ⭐ 34,344 \| 🐛 695 \| 🌐 Rust \| 📅 2026-09-02                                                                                                                                                                                                                                                                               | High-performance vector DB in Rust.                                                     |
| [Milvus](https://github.com/milvus-io/milvus) ⭐ 45,933 \| 🐛 1,322 \| 🌐 Go \| 📅 2026-09-02                                                                                                                                                                                                                                                                            | Cloud-native vector DB. Billion-scale.                                                  |
...
| Tool                                                                                                 | Description                                                       |
| ---------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| [Ollama](https://github.com/ollama/ollama) ⭐ 179,989 \| 🐛 3,886 \| 🌐 Go \| 📅 2026-09-02           | Run LLMs locally. 162k+ stars. Dead simple CLI.                   |
| [llama.cpp](https://github.com/ggml-org/llama.cpp) ⭐ 126,805 \| 🐛 2,366 \| 🌐 C++ \| 📅 2026-09-02  | C/C++ inference. CPU, GPU, Apple Silicon. Foundation of local AI. |
| [vLLM](https://github.com/vllm-project/vllm) ⭐ 90,799 \| 🐛 7,350 \| 🌐 Python \| 📅 2026-09-02      | High-throughput serving. PagedAttention. Production-grade.        |
| [LM Studio](https://lmstudio.ai)                                                                     | Desktop app for local LLMs. Beautiful UI. All platforms.          |
| [Jan](https://github.com/janhq/jan) ⭐ 44,304 \| 🐛 508 \| 🌐 TypeScript \| 📅 2026-09-02             | OSS ChatGPT alternative. 100% offline.                            |
| [LocalAI](https://github.com/mudler/LocalAI) ⭐ 48,829 \| 🐛 200 \| 🌐 Go \| 📅 2026-09-02            | Drop-in OpenAI API replacement. No GPU required.                  |
...
| [GPT4All](https://github.com/nomic-ai/gpt4all) ⭐ 77,387 \| 🐛 772 \| 🌐 C++ \| 📅 2025-05-27         | OSS local chat. Consumer hardware.                                |
| [Llamafile](https://github.com/Mozilla-Ocho/llamafile) ⭐ 25,857 \| 🐛 212 \| 🌐 C++ \| 📅 2026-08-26 | LLMs as single files. Zero setup. Mozilla.                        |

### Self-Hosted Agents and UIs

| Tool                                                                                                               | Description                                                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Open WebUI](https://github.com/open-webui/open-webui) ⭐ 150,729 \| 🐛 236 \| 🌐 Python \| 📅 2026-09-02           | Self-hosted ChatGPT UI. Access control. Extensions.                                                                                                                                                            |
| [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 388,650 \| 🐛 6,136 \| 🌐 TypeScript \| 📅 2026-09-02           | Fastest-growing GitHub repo ever (9k to 188k stars in 60 days). Self-hosted agent across WhatsApp, Telegram, Slack, Discord, Signal. 5,700+ community skills.                                                  |
...
| [LibreChat](https://github.com/danny-avila/LibreChat) ⭐ 42,736 \| 🐛 726 \| 🌐 TypeScript \| 📅 2026-09-02         | Self-hosted multi-model chat. All major providers.                                                                                                                                                             |
| [LobeChat](https://github.com/lobehub/lobe-chat) ⭐ 82,169 \| 🐛 871 \| 🌐 TypeScript \| 📅 2026-09-02              | OSS ChatGPT/Gemini UI. Plugin system. Multi-modal.                                                                                                                                                             |
...
| [Anything LLM](https://github.com/Mintplex-Labs/anything-llm) ⭐ 65,521 \| 🐛 321 \| 🌐 JavaScript \| 📅 2026-09-02 | All-in-one AI app. RAG, agents. Desktop + Docker.                                                                                                                                                              |
| [DB-GPT](https://github.com/eosphoros-ai/DB-GPT) ⭐ 19,846 \| 🐛 428 \| 🌐 Python \| 📅 2026-08-31                  | Data interaction with local LLM. 100% private.                                                                                                                                                                 |
...
| [Cursor AI Automated Team](https://github.com/joinwell52-AI/joinwell52) ⭐ 5 \| 🐛 4 \| 🌐 JavaScript \| 📅 2026-09-02 | 4-role AI team (PM+DEV+OPS+QA) in Cursor IDE. File-based task routing, auto patrol bot. 87 person-days in 17 days.                                | Free / OSS        |
...
| [A2A (Agent-to-Agent)](https://github.com/google/A2A) ⭐ 25,606 \| 🐛 240 \| 🌐 Shell \| 📅 2026-09-01     | Google protocol for inter-agent communication. Horizontal agent collaboration.                                                                     |
...
| [OpenAPI](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,197 \| 🐛 76 \| 🌐 Markdown \| 📅 2026-09-01 | Industry-standard API spec. Foundation for agent tools.                                                                                            |
...
| Tool                                                                                            | Description                                                                                                                                                                            |
| ----------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Entroly](https://github.com/juyterman1000/entroly) ⭐ 443 \| 🐛 3 \| 🌐 Python \| 📅 2026-09-02 | Context engineering engine. 100% codebase visibility with 78% fewer tokens. Knapsack-optimal selection, SimHash dedup, RL from response quality. Rust engine, <10ms. MCP + HTTP proxy. |

### Tracing and Monitoring

| Tool                                                                                                     | Description                                                                                                                          |
| -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| [Langfuse](https://github.com/langfuse/langfuse) ⭐ 34,109 \| 🐛 874 \| 🌐 TypeScript \| 📅 2026-09-02    | OSS LLM observability. Traces, evals, prompts.                                                                                       |
...
| [Arize Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,298 \| 🐛 957 \| 🌐 Python \| 📅 2026-09-02    | OSS AI observability. Traces, evals, embeddings.                                                                                     |
| [Helicone](https://github.com/Helicone/helicone) ⭐ 6,126 \| 🐛 155 \| 🌐 TypeScript \| 📅 2026-08-31     | OSS LLM observability. One-line integration.                                                                                         |
...
| ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| [SWE-bench](https://github.com/princeton-nlp/SWE-bench) ⭐ 5,765 \| 🐛 9 \| 🌐 Python \| 📅 2026-09-02 | Industry standard for coding agents. Top: 80.9% (Claude Opus 4.6). |
| [AgentBench](https://github.com/THUDM/AgentBench) ⭐ 3,711 \| 🐛 76 \| 🌐 Python \| 📅 2026-02-08      | 8-environment LLM agent benchmark.                                 |
...
| [WebArena](https://github.com/web-arena-x/webarena) ⭐ 1,592 \| 🐛 102 \| 🌐 Python \| 📅 2025-11-26   | Web agent benchmark. Real websites.                                |
...
| [Qwen3.6-Plus](https://github.com/QwenLM/Qwen3) ⭐ 27,587 \| 🐛 66 \| 🌐 Python \| 📅 2026-01-09                | Alibaba   | Various   | ⭐ **NEW (Apr 2026)** Agentic focus. 1M ctx. Repo-level coding. MCP-native. |
| [Qwen3.5-Omni](https://github.com/QwenLM/Qwen3) ⭐ 27,587 \| 🐛 66 \| 🌐 Python \| 📅 2026-01-09                | Alibaba   | 397B MoE  | Native multimodal. Text, image, audio.                                     |
| [DeepSeek V3/R1](https://github.com/deepseek-ai/DeepSeek-V3) ⭐ 104,434 \| 🐛 214 \| 🌐 Python \| 📅 2025-08-28 | DeepSeek  | 671B MoE  | 68x cheaper. Strong reasoning. V4 Lite in preview.                         |
| [Gemma 4](https://github.com/google-deepmind/gemma) ⭐ 5,710 \| 🐛 328 \| 🌐 Python \| 📅 2026-09-01            | Google    | 2B-31B    | ⭐ **NEW (Apr 2026)** Consumer/IoT optimized. E2B, E4B variants.            |
...
| Tool                                                                                                         | Description                                                                      |
| ------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------- |
| [Guardrails AI](https://github.com/guardrails-ai/guardrails) ⭐ 7,346 \| 🐛 82 \| 🌐 Python \| 📅 2026-09-01  | Structural, type, quality guarantees for LLM outputs.                            |
| [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) ⭐ 7,050 \| 🐛 213 \| 🌐 Python \| 📅 2026-09-02 | NVIDIA. Programmable conversation guardrails.                                    |
...
| [PentestGPT](https://github.com/GreyDGL/PentestGPT) ⭐ 15,194 \| 🐛 73 \| 🌐 Python \| 📅 2026-07-14         | GPT-powered pentesting. Automated reasoning.                                                                                |
...
| [Prism Scanner](https://github.com/aidongise-cell/prism-scanner) ⭐ 19 \| 🐛 0 \| 🌐 Python \| 📅 2026-04-07 | OSS security scanner for AI agent skills/plugins/MCP servers. Pre-install taint tracking, post-uninstall residue detection. |
...
* [Microsoft GenAI for Beginners](https://github.com/microsoft/generative-ai-for-beginners) ⭐ 119,023 | 🐛 28 | 🌐 Jupyter Notebook | 📅 2026-08-27 - 21-lesson course
* [OpenAI Cookbook](https://github.com/openai/openai-cookbook) ⭐ 75,710 | 🐛 297 | 🌐 Jupyter Notebook | 📅 2026-09-02 - Practical API guides
* [Anthropic Cookbook](https://github.com/anthropics/anthropic-cookbook) ⭐ 52,370 | 🐛 318 | 🌐 Jupyter Notebook | 📅 2026-09-02 - Claude agent recipes
