...
[![Stars](https://img.shields.io/github/stars/caramaschiHG/awesome-ai-agents-2026?style=flat-square\&color=yellow)](https://github.com/caramaschiHG/awesome-ai-agents-2026/stargazers) ⭐ 1,597 | 🐛 356 | 📅 2026-06-10
...
| [OpenAI Codex CLI](https://github.com/openai/codex) ⭐ 107,091 \| 🐛 13,246 \| 🌐 Rust \| 📅 2026-08-20          | OpenAI terminal agent. Agents SDK. Multi-agent.                                                                             | ChatGPT sub            |
| [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,591 \| 🐛 793 \| 🌐 TypeScript \| 📅 2026-08-20 | ⭐ **NEW (Apr 2026)** Google's official open-source terminal agent. ReAct loop. MCP support. 1M context. Apache 2.0.         | Free w/ Google account |
| [Aider](https://github.com/paul-gauthier/aider) ⭐ 48,353 \| 🐛 1,819 \| 🌐 Python \| 📅 2026-05-22              | OSS pair programmer. Git-aware. Any LLM.                                                                                    | Free + API             |
| [Cline](https://github.com/cline/cline) ⭐ 66,544 \| 🐛 1,055 \| 🌐 TypeScript \| 📅 2026-08-20                  | VS Code extension. Full terminal and browser access for Claude/GPT.                                                         | Free + API             |
...
| [Caliber](https://github.com/caliber-ai-org/ai-setup) ⭐ 1,248 \| 🐛 16 \| 🌐 TypeScript \| 📅 2026-07-26        | CLI that fingerprints projects and generates/syncs AI agent configs (CLAUDE.md, .cursor/rules/, AGENTS.md). Scores quality. | Free + API             |
...
| [SWE-Agent](https://github.com/princeton-nlp/SWE-agent) ⭐ 20,090 \| 🐛 82 \| 🌐 Python \| 📅 2026-08-17     | Princeton. Resolves real GitHub issues autonomously.                                   | Free (OSS)   |
| [OpenHands](https://github.com/All-Hands-AI/OpenHands) ⭐ 84,607 \| 🐛 504 \| 🌐 TypeScript \| 📅 2026-08-20 | OSS autonomous software engineer (ex-OpenDevin).                                       | Free (OSS)   |
...
| [PR-Agent](https://github.com/Codium-ai/pr-agent) ⭐ 12,633 \| 🐛 105 \| 🌐 Python \| 📅 2026-08-20 | OSS AI PR reviewer. Auto-describe, review, improve. | Free (OSS)        |
...
| [Dyad](https://github.com/dyad-sh/dyad) ⭐ 21,292 \| 🐛 293 \| 🌐 TypeScript \| 📅 2026-08-20 | OSS. Local-first. No-code app builder.     | Free (OSS)    |
...
| ------------------------------------------------------------------------------------------------------------------- | ---------- | --------------------------------------------------------------------------- |
| [LangChain](https://github.com/langchain-ai/langchain) ⭐ 144,640 \| 🐛 413 \| 🌐 Python \| 📅 2026-08-20            | Py/JS      | Most adopted. Modular architecture, memory, tools.                          |
| [LangGraph](https://github.com/langchain-ai/langgraph) ⭐ 40,109 \| 🐛 702 \| 🌐 Python \| 📅 2026-08-20             | Py/JS      | Graph-based orchestration. Stateful directed graphs.                        |
| [LlamaIndex](https://github.com/run-llama/llama_index) ⭐ 51,770 \| 🐛 642 \| 🌐 Python \| 📅 2026-08-20             | Py/JS      | Data-focused. Best for RAG agents.                                          |
| [Haystack](https://github.com/deepset-ai/haystack) ⭐ 26,261 \| 🐛 99 \| 🌐 Python \| 📅 2026-08-20                  | Py         | Pipeline-based. Search and retrieval.                                       |
| [Semantic Kernel](https://github.com/microsoft/semantic-kernel) ⭐ 28,468 \| 🐛 249 \| 🌐 C# \| 📅 2026-08-20        | C#/Py/Java | Microsoft enterprise. Azure integration.                                    |
| [Pydantic AI](https://github.com/pydantic/pydantic-ai) ⭐ 19,417 \| 🐛 727 \| 🌐 Python \| 📅 2026-08-20             | Py         | Type-safe. Clean Pythonic API. Production-ready.                            |
| [DSPy](https://github.com/stanfordnlp/dspy) ⭐ 37,452 \| 🐛 665 \| 🌐 Python \| 📅 2026-08-20                        | Py         | Stanford. Programming not prompting. Auto-optimizes.                        |
| [Mastra](https://github.com/mastra-ai/mastra) ⭐ 27,336 \| 🐛 497 \| 🌐 TypeScript \| 📅 2026-08-20                  | TS         | TypeScript-first. Observational Memory. Apache 2.0.                         |
| [Anthropic SDK](https://github.com/anthropics/anthropic-sdk-python) ⭐ 3,835 \| 🐛 143 \| 🌐 Python \| 📅 2026-08-20 | Py/TS      | Official Claude SDK. Tool use, computer control, streaming.                 |
| [Google ADK](https://github.com/google/adk-python) ⭐ 21,204 \| 🐛 535 \| 🌐 Python \| 📅 2026-08-20                 | Py         | ⭐ Google's Agent Development Kit. Native Gemini. Multi-agent orchestration. |

### Multi-Agent Orchestration

| Framework                                                                                                           | Lang               | Description                                                                                                            |
| ------------------------------------------------------------------------------------------------------------------- | ------------------ | ---------------------------------------------------------------------------------------------------------------------- |
| [AutoGen](https://github.com/microsoft/autogen) ⭐ 60,539 \| 🐛 998 \| 🌐 Python \| 📅 2026-04-15                    | Py                 | Microsoft multi-agent conversations.                                                                                   |
| [CrewAI](https://github.com/crewAIInc/crewAI) ⭐ 57,392 \| 🐛 826 \| 🌐 Python \| 📅 2026-08-20                      | Py                 | Role-based crew members with goals and tools. Used by 60%+ Fortune 500.                                                |
| [MetaGPT](https://github.com/geekan/MetaGPT) ⭐ 69,912 \| 🐛 130 \| 🌐 Python \| 📅 2026-01-21                       | Py                 | PM, architect, engineer roles. Software company sim.                                                                   |
...
| [OpenAI Agents SDK](https://github.com/openai/openai-agents-python) ⭐ 28,794 \| 🐛 17 \| 🌐 Python \| 📅 2026-08-20 | Py                 | Official. Multi-step agents with handoffs.                                                                             |
| [Strands Agents](https://github.com/strands-agents/sdk-python) ⭐ 6,960 \| 🐛 656 \| 🌐 Python \| 📅 2026-08-20      | Py                 | AWS-backed. Model-driven tool use.                                                                                     |
| [CAMEL](https://github.com/camel-ai/camel) ⭐ 17,611 \| 🐛 474 \| 🌐 Python \| 📅 2026-08-14                         | Py                 | Role-based simulation. Collaborative reasoning.                                                                        |
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) ⭐ 186,686 \| 🐛 514 \| 🌐 Python \| 📅 2026-08-20        | Py                 | Pioneer. Now full platform with visual builder.                                                                        |
| [Bernstein](https://github.com/chernistry/bernstein) ⭐ 940 \| 🐛 201 \| 🌐 Python \| 📅 2026-08-20                  | Py                 | Deterministic orchestrator. Parallel coding agents, test-driven verification. Zero LLM tokens on coordination.         |
| [AgentScope](https://github.com/modelscope/agentscope) ⭐ 29,101 \| 🐛 344 \| 🌐 Python \| 📅 2026-08-20             | Py                 | Alibaba multi-agent framework.                                                                                         |
...
| [DeerFlow](https://github.com/bytedance/deer-flow) ⭐ 80,419 \| 🐛 921 \| 🌐 Python \| 📅 2026-08-20                 | Py                 | ByteDance. No.1 GitHub Trending Feb 2026. 25k+ stars.                                                                  |
...
| Framework                                                                                                | Lang | Description                               |
| -------------------------------------------------------------------------------------------------------- | ---- | ----------------------------------------- |
| [Smolagents](https://github.com/huggingface/smolagents) ⭐ 28,907 \| 🐛 790 \| 🌐 Python \| 📅 2026-07-21 | Py   | HuggingFace minimal agents. \~1000 lines. |
| [Agno](https://github.com/agno-agi/agno) ⭐ 41,804 \| 🐛 1,268 \| 🌐 Python \| 📅 2026-08-20              | Py   | Lightweight, model-agnostic.              |
| [Upsonic](https://github.com/upsonic/upsonic) ⭐ 7,943 \| 🐛 31 \| 🌐 Python \| 📅 2026-06-18             | Py   | MCP support. Minimal setup.               |
...
| --------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [OpenClaw Agent Templates](https://github.com/mergisi/awesome-openclaw-agents) ⭐ 3,921 \| 🐛 86 \| 🌐 HTML \| 📅 2026-05-25 | 177 production-ready SOUL.md configs across 24 categories (PM, SEO, DevOps, Writer, Support). Copy-paste ready for [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 386,904 \| 🐛 5,796 \| 🌐 TypeScript \| 📅 2026-08-20. Visual deploy via [CrewClaw](https://crewclaw.com). |
...
| Tool                                                                                                             | Description                                                                                                                                      |
| ---------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Browser Use](https://github.com/browser-use/browser-use) ⭐ 109,870 \| 🐛 365 \| 🌐 Python \| 📅 2026-08-19      | OSS browser agent library. Used by Manus.                                                                                                        |
| [Skyvern](https://github.com/Skyvern-AI/skyvern) ⭐ 22,802 \| 🐛 214 \| 🌐 Python \| 📅 2026-08-20                | Vision-driven. GPT-4V navigation without coded selectors.                                                                                        |
| [Agent S2 (Simular)](https://github.com/simular-ai/Agent-S) ⭐ 12,177 \| 🐛 40 \| 🌐 Python \| 📅 2026-08-01      | OSS GUI automation framework.                                                                                                                    |
...
| [Plasmate](https://github.com/plasmate-labs/plasmate) ⭐ 34 \| 🐛 1 \| 🌐 Rust \| 📅 2026-08-20                   | Headless browser compiling HTML to structured JSON (SOM). 17.5x compression, 13 MCP tools. First browser tool on MCP Registry. Rust, Apache-2.0. |
| [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 36,305 \| 🐛 1 \| 🌐 TypeScript \| 📅 2026-08-20 | MCP server for Playwright + AI agents.                                                                                                           |
...
| Tool                                                                                                 | Description                                       |
| ---------------------------------------------------------------------------------------------------- | ------------------------------------------------- |
| [LiveKit Agents](https://github.com/livekit/agents) ⭐ 13,106 \| 🐛 778 \| 🌐 Python \| 📅 2026-08-20 | OSS real-time voice/video AI agents.              |
| [Rasa](https://github.com/RasaHQ/rasa) ⭐ 21,296 \| 🐛 153 \| 🌐 Python \| 📅 2026-07-24              | OSS conversational AI. Self-hosted. NLU training. |
| [Pipecat](https://github.com/pipecat-ai/pipecat) ⭐ 14,353 \| 🐛 236 \| 🌐 Python \| 📅 2026-08-20    | OSS voice and multimodal conversational AI.       |
| [Vocode](https://github.com/vocodedev/vocode-python) ⭐ 3,784 \| 🐛 2 \| 🌐 Python \| 📅 2024-11-15   | OSS voice-based LLM agents.                       |
...
| [InkOS](https://github.com/Narcooo/inkos) ⭐ 9,158 \| 🐛 228 \| 🌐 TypeScript \| 📅 2026-08-17 | Autonomous novel-writing CLI agent. Agents collaborate to produce long-form fiction with continuity auditing, anti-AI-slop filtering, and style cloning. | Free / OSS     |
...
| [Wan 2.1](https://github.com/Wan-Video/Wan2.1) ⭐ 16,870 \| 🐛 376 \| 🌐 Python \| 📅 2026-03-05          | Best free OSS video gen. Self-hostable. No limits.                                 | Free (OSS)       |
| [HunyuanVideo](https://github.com/Tencent/HunyuanVideo) ⭐ 12,444 \| 🐛 183 \| 🌐 Python \| 📅 2026-06-29 | Tencent OSS. Consumer GPU. Multi-style.                                            | Free (OSS)       |
| [LTX Video](https://github.com/Lightricks/LTX-Video) ⭐ 10,874 \| 🐛 99 \| 🌐 Python \| 📅 2026-01-05     | OSS. Licensed data. Clear commercial terms.                                        | Free (OSS)       |
...
| Agent                                                                                                             | Description                                                                                                                              | Pricing        |
| ----------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- | -------------- |
| [n8n](https://github.com/n8n-io/n8n) ⭐ 201,356 \| 🐛 1,075 \| 🌐 TypeScript \| 📅 2026-08-20                      | OSS workflow automation with AI agent nodes. Visual + code.                                                                              | Free / Cloud   |
...
| [Activepieces](https://github.com/activepieces/activepieces) ⭐ 23,932 \| 🐛 482 \| 🌐 TypeScript \| 📅 2026-08-20 | OSS Zapier alternative with AI.                                                                                                          | Free (OSS)     |
| [Temporal](https://github.com/temporalio/temporal) ⭐ 22,421 \| 🐛 901 \| 🌐 Go \| 📅 2026-08-20                   | Durable execution for long-running agent workflows.                                                                                      | Free / Cloud   |
| [Mission Control](https://github.com/MeisnerDan/mission-control) ⭐ 711 \| 🐛 17 \| 🌐 TypeScript \| 📅 2026-04-01 | Cockpit for the agentic era — manage AI agent swarms with autonomous daemon, Field Ops for real-world execution, and approval workflows. | Free (OSS)     |

### No-Code Agent Builders

| Agent                                                                                                 | Description                                                                                                                                            | Pricing      |
| ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------ |
| [Dify](https://github.com/langgenius/dify) ⭐ 153,039 \| 🐛 983 \| 🌐 TypeScript \| 📅 2026-08-20      | OSS LLMOps. Visual agent builder. RAG. 130k+ stars.                                                                                                    | Free / Cloud |
| [Flowise](https://github.com/FlowiseAI/Flowise) ⚠️ Archived                                           | OSS drag-and-drop LLM agent builder.                                                                                                                   | Free (OSS)   |
| [Langflow](https://github.com/langflow-ai/langflow) ⭐ 153,506 \| 🐛 966 \| 🌐 Python \| 📅 2026-08-20 | Visual multi-agent and RAG builder.                                                                                                                    | Free / Cloud |
...
| [DeerFlow](https://github.com/bytedance/deer-flow) ⭐ 80,419 \| 🐛 921 \| 🌐 Python \| 📅 2026-08-20              | ByteDance OSS. Planning, tools, memory, execution.            | Free (OSS)      |
| [GPT Researcher](https://github.com/assafelovic/gpt-researcher) ⭐ 29,057 \| 🐛 181 \| 🌐 Python \| 📅 2026-07-18 | OSS autonomous comprehensive research.                        | Free (OSS)      |
| [STORM](https://github.com/stanford-oval/storm) ⭐ 31,082 \| 🐛 107 \| 🌐 Python \| 📅 2025-09-30                 | Stanford. Writes Wikipedia-like articles from scratch.        | Free (OSS)      |
...
| [PandasAI](https://github.com/Sinaptik-AI/pandas-ai) ⭐ 23,760 \| 🐛 21 \| 🌐 Python \| 📅 2025-10-28 | Chat with your data. NL to Pandas/SQL.                                                                                                                                                            | Free (OSS)  |
...
| Tool                                                                                                                                                                                                                                                                                                                                                                    | Description                                                                             |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| [RAGFlow](https://github.com/infiniflow/ragflow) ⭐ 88,923 \| 🐛 1,772 \| 🌐 Go \| 📅 2026-08-20                                                                                                                                                                                                                                                                         | OSS RAG engine with agent capabilities.                                                 |
...
| [Pathway](https://github.com/pathwaycom/pathway) ⭐ 62,413 \| 🐛 35 \| 🌐 Python \| 📅 2026-08-20                                                                                                                                                                                                                                                                        | Live data RAG. Real-time streaming. 50k+ stars.                                         |
| [Mem0](https://github.com/mem0ai/mem0) ⭐ 63,695 \| 🐛 681 \| 🌐 Python \| 📅 2026-08-20                                                                                                                                                                                                                                                                                 | Memory layer for agents. Long-term across sessions.                                     |
...
| [Chroma](https://github.com/chroma-core/chroma) ⭐ 29,107 \| 🐛 795 \| 🌐 Rust \| 📅 2026-08-20                                                                                                                                                                                                                                                                          | OSS embedding database. Fastest way to build RAG.                                       |
| [Weaviate](https://github.com/weaviate/weaviate) ⭐ 16,742 \| 🐛 691 \| 🌐 Go \| 📅 2026-08-20                                                                                                                                                                                                                                                                           | OSS vector DB. GraphQL. Multi-modal search.                                             |
| [Qdrant](https://github.com/qdrant/qdrant) ⭐ 34,093 \| 🐛 688 \| 🌐 Rust \| 📅 2026-08-20                                                                                                                                                                                                                                                                               | High-performance vector DB in Rust.                                                     |
| [Milvus](https://github.com/milvus-io/milvus) ⭐ 45,713 \| 🐛 1,318 \| 🌐 Go \| 📅 2026-08-20                                                                                                                                                                                                                                                                            | Cloud-native vector DB. Billion-scale.                                                  |
...
| Tool                                                                                                 | Description                                                       |
| ---------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| [Ollama](https://github.com/ollama/ollama) ⭐ 179,045 \| 🐛 3,762 \| 🌐 Go \| 📅 2026-08-20           | Run LLMs locally. 162k+ stars. Dead simple CLI.                   |
| [llama.cpp](https://github.com/ggml-org/llama.cpp) ⭐ 124,853 \| 🐛 2,131 \| 🌐 C++ \| 📅 2026-08-20  | C/C++ inference. CPU, GPU, Apple Silicon. Foundation of local AI. |
| [vLLM](https://github.com/vllm-project/vllm) ⭐ 89,546 \| 🐛 6,843 \| 🌐 Python \| 📅 2026-08-20      | High-throughput serving. PagedAttention. Production-grade.        |
| [LM Studio](https://lmstudio.ai)                                                                     | Desktop app for local LLMs. Beautiful UI. All platforms.          |
| [Jan](https://github.com/janhq/jan) ⭐ 44,074 \| 🐛 466 \| 🌐 TypeScript \| 📅 2026-08-20             | OSS ChatGPT alternative. 100% offline.                            |
| [LocalAI](https://github.com/mudler/LocalAI) ⭐ 48,597 \| 🐛 180 \| 🌐 Go \| 📅 2026-08-20            | Drop-in OpenAI API replacement. No GPU required.                  |
...
| [GPT4All](https://github.com/nomic-ai/gpt4all) ⭐ 77,403 \| 🐛 772 \| 🌐 C++ \| 📅 2025-05-27         | OSS local chat. Consumer hardware.                                |
| [Llamafile](https://github.com/Mozilla-Ocho/llamafile) ⭐ 25,659 \| 🐛 213 \| 🌐 C++ \| 📅 2026-08-17 | LLMs as single files. Zero setup. Mozilla.                        |

### Self-Hosted Agents and UIs

| Tool                                                                                                               | Description                                                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Open WebUI](https://github.com/open-webui/open-webui) ⭐ 149,365 \| 🐛 383 \| 🌐 Python \| 📅 2026-08-20           | Self-hosted ChatGPT UI. Access control. Extensions.                                                                                                                                                            |
| [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 386,904 \| 🐛 5,796 \| 🌐 TypeScript \| 📅 2026-08-20           | Fastest-growing GitHub repo ever (9k to 188k stars in 60 days). Self-hosted agent across WhatsApp, Telegram, Slack, Discord, Signal. 5,700+ community skills.                                                  |
...
| [LibreChat](https://github.com/danny-avila/LibreChat) ⭐ 42,282 \| 🐛 729 \| 🌐 TypeScript \| 📅 2026-08-20         | Self-hosted multi-model chat. All major providers.                                                                                                                                                             |
| [LobeChat](https://github.com/lobehub/lobe-chat) ⭐ 81,854 \| 🐛 774 \| 🌐 TypeScript \| 📅 2026-08-20              | OSS ChatGPT/Gemini UI. Plugin system. Multi-modal.                                                                                                                                                             |
...
| [Anything LLM](https://github.com/Mintplex-Labs/anything-llm) ⭐ 64,975 \| 🐛 316 \| 🌐 JavaScript \| 📅 2026-08-20 | All-in-one AI app. RAG, agents. Desktop + Docker.                                                                                                                                                              |
| [DB-GPT](https://github.com/eosphoros-ai/DB-GPT) ⭐ 19,770 \| 🐛 428 \| 🌐 Python \| 📅 2026-08-20                  | Data interaction with local LLM. 100% private.                                                                                                                                                                 |
...
| [Cursor AI Automated Team](https://github.com/joinwell52-AI/joinwell52) ⭐ 4 \| 🐛 3 \| 🌐 JavaScript \| 📅 2026-08-20 | 4-role AI team (PM+DEV+OPS+QA) in Cursor IDE. File-based task routing, auto patrol bot. 87 person-days in 17 days.                                | Free / OSS        |
...
| [A2A (Agent-to-Agent)](https://github.com/google/A2A) ⭐ 25,434 \| 🐛 237 \| 🌐 Shell \| 📅 2026-08-18      | Google protocol for inter-agent communication. Horizontal agent collaboration.                                                                     |
...
| [OpenAPI](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,164 \| 🐛 117 \| 🌐 Markdown \| 📅 2026-08-20 | Industry-standard API spec. Foundation for agent tools.                                                                                            |
...
| Tool                                                                                                     | Description                                                                                                                          |
| -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| [Langfuse](https://github.com/langfuse/langfuse) ⭐ 33,471 \| 🐛 788 \| 🌐 TypeScript \| 📅 2026-08-20    | OSS LLM observability. Traces, evals, prompts.                                                                                       |
...
| [Arize Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,129 \| 🐛 947 \| 🌐 Python \| 📅 2026-08-20    | OSS AI observability. Traces, evals, embeddings.                                                                                     |
| [Helicone](https://github.com/Helicone/helicone) ⭐ 6,088 \| 🐛 149 \| 🌐 TypeScript \| 📅 2026-08-16     | OSS LLM observability. One-line integration.                                                                                         |
...
| ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| [SWE-bench](https://github.com/princeton-nlp/SWE-bench) ⭐ 5,675 \| 🐛 8 \| 🌐 Python \| 📅 2026-08-18 | Industry standard for coding agents. Top: 80.9% (Claude Opus 4.6). |
| [AgentBench](https://github.com/THUDM/AgentBench) ⭐ 3,676 \| 🐛 75 \| 🌐 Python \| 📅 2026-02-08      | 8-environment LLM agent benchmark.                                 |
...
| [Qwen3.6-Plus](https://github.com/QwenLM/Qwen3) ⭐ 27,540 \| 🐛 64 \| 🌐 Python \| 📅 2026-01-09                | Alibaba   | Various   | ⭐ **NEW (Apr 2026)** Agentic focus. 1M ctx. Repo-level coding. MCP-native. |
| [Qwen3.5-Omni](https://github.com/QwenLM/Qwen3) ⭐ 27,540 \| 🐛 64 \| 🌐 Python \| 📅 2026-01-09                | Alibaba   | 397B MoE  | Native multimodal. Text, image, audio.                                     |
| [DeepSeek V3/R1](https://github.com/deepseek-ai/DeepSeek-V3) ⭐ 104,352 \| 🐛 209 \| 🌐 Python \| 📅 2025-08-28 | DeepSeek  | 671B MoE  | 68x cheaper. Strong reasoning. V4 Lite in preview.                         |
| [Gemma 4](https://github.com/google-deepmind/gemma) ⭐ 5,672 \| 🐛 315 \| 🌐 Python \| 📅 2026-08-10            | Google    | 2B-31B    | ⭐ **NEW (Apr 2026)** Consumer/IoT optimized. E2B, E4B variants.            |
...
| Tool                                                                                                         | Description                                                                      |
| ------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------- |
| [Guardrails AI](https://github.com/guardrails-ai/guardrails) ⭐ 7,304 \| 🐛 88 \| 🌐 Python \| 📅 2026-08-19  | Structural, type, quality guarantees for LLM outputs.                            |
| [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) ⭐ 6,984 \| 🐛 219 \| 🌐 Python \| 📅 2026-08-20 | NVIDIA. Programmable conversation guardrails.                                    |
...
| Agent                                                                                                       | Description                                                                                                                 |
| ----------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| [CAI](https://github.com/aliasrobotics/CAI) ⭐ 9,780 \| 🐛 18 \| 🌐 Python \| 📅 2026-07-14                  | AI pentesting, vuln discovery, red teaming. HITL.                                                                           |
| [YAWNING TITAN](https://github.com/dstl/YAWNING-TITAN) ⚠️ Archived                                          | Graph-based cybersecurity simulation.                                                                                       |
| [PentestGPT](https://github.com/GreyDGL/PentestGPT) ⭐ 14,966 \| 🐛 69 \| 🌐 Python \| 📅 2026-07-14         | GPT-powered pentesting. Automated reasoning.                                                                                |
...
* [Microsoft GenAI for Beginners](https://github.com/microsoft/generative-ai-for-beginners) ⭐ 118,204 | 🐛 28 | 🌐 Jupyter Notebook | 📅 2026-08-20 - 21-lesson course
* [OpenAI Cookbook](https://github.com/openai/openai-cookbook) ⭐ 75,392 | 🐛 247 | 🌐 Jupyter Notebook | 📅 2026-08-20 - Practical API guides
* [Anthropic Cookbook](https://github.com/anthropics/anthropic-cookbook) ⭐ 51,905 | 🐛 313 | 🌐 Jupyter Notebook | 📅 2026-08-19 - Claude agent recipes
