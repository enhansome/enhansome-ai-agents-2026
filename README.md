...
[![Stars](https://img.shields.io/github/stars/caramaschiHG/awesome-ai-agents-2026?style=flat-square\&color=yellow)](https://github.com/caramaschiHG/awesome-ai-agents-2026/stargazers) ⭐ 1,892 | 🐛 404 | 📅 2026-06-10
...
| [OpenAI Codex CLI](https://github.com/openai/codex) ⭐ 125,742 \| 🐛 18,152 \| 🌐 Rust \| 📅 2026-09-21          | OpenAI terminal agent. Agents SDK. Multi-agent.                                                                             | ChatGPT sub            |
| [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 107,117 \| 🐛 834 \| 🌐 TypeScript \| 📅 2026-09-21 | ⭐ **NEW (Apr 2026)** Google's official open-source terminal agent. ReAct loop. MCP support. 1M context. Apache 2.0.         | Free w/ Google account |
| [Aider](https://github.com/paul-gauthier/aider) ⭐ 49,103 \| 🐛 1,882 \| 🌐 Python \| 📅 2026-05-22              | OSS pair programmer. Git-aware. Any LLM.                                                                                    | Free + API             |
| [Cline](https://github.com/cline/cline) ⭐ 68,964 \| 🐛 1,389 \| 🌐 TypeScript \| 📅 2026-09-21                  | VS Code extension. Full terminal and browser access for Claude/GPT.                                                         | Free + API             |
...
| [Caliber](https://github.com/caliber-ai-org/ai-setup) ⭐ 1,277 \| 🐛 18 \| 🌐 TypeScript \| 📅 2026-09-19        | CLI that fingerprints projects and generates/syncs AI agent configs (CLAUDE.md, .cursor/rules/, AGENTS.md). Scores quality. | Free + API             |
...
| [SWE-Agent](https://github.com/princeton-nlp/SWE-agent) ⭐ 20,382 \| 🐛 117 \| 🌐 Python \| 📅 2026-09-21    | Princeton. Resolves real GitHub issues autonomously.                                   | Free (OSS)   |
| [OpenHands](https://github.com/All-Hands-AI/OpenHands) ⭐ 88,736 \| 🐛 871 \| 🌐 TypeScript \| 📅 2026-09-21 | OSS autonomous software engineer (ex-OpenDevin).                                       | Free (OSS)   |
...
| [PR-Agent](https://github.com/Codium-ai/pr-agent) ⭐ 13,100 \| 🐛 45 \| 🌐 Python \| 📅 2026-09-21 | OSS AI PR reviewer. Auto-describe, review, improve. | Free (OSS)        |
...
| [Dyad](https://github.com/dyad-sh/dyad) ⭐ 21,594 \| 🐛 340 \| 🌐 TypeScript \| 📅 2026-09-21 | OSS. Local-first. No-code app builder.     | Free (OSS)    |
...
| ------------------------------------------------------------------------------------------------------------------- | ---------- | --------------------------------------------------------------------------- |
| [LangChain](https://github.com/langchain-ai/langchain) ⭐ 146,821 \| 🐛 541 \| 🌐 Python \| 📅 2026-09-21            | Py/JS      | Most adopted. Modular architecture, memory, tools.                          |
| [LangGraph](https://github.com/langchain-ai/langgraph) ⭐ 42,095 \| 🐛 808 \| 🌐 Python \| 📅 2026-09-21             | Py/JS      | Graph-based orchestration. Stateful directed graphs.                        |
| [LlamaIndex](https://github.com/run-llama/llama_index) ⭐ 52,268 \| 🐛 815 \| 🌐 Python \| 📅 2026-09-21             | Py/JS      | Data-focused. Best for RAG agents.                                          |
| [Haystack](https://github.com/deepset-ai/haystack) ⭐ 26,572 \| 🐛 168 \| 🌐 Python \| 📅 2026-09-21                 | Py         | Pipeline-based. Search and retrieval.                                       |
| [Semantic Kernel](https://github.com/microsoft/semantic-kernel) ⭐ 28,587 \| 🐛 312 \| 🌐 C# \| 📅 2026-09-19        | C#/Py/Java | Microsoft enterprise. Azure integration.                                    |
| [Pydantic AI](https://github.com/pydantic/pydantic-ai) ⭐ 20,102 \| 🐛 944 \| 🌐 Python \| 📅 2026-09-21             | Py         | Type-safe. Clean Pythonic API. Production-ready.                            |
| [DSPy](https://github.com/stanfordnlp/dspy) ⭐ 38,184 \| 🐛 715 \| 🌐 Python \| 📅 2026-09-21                        | Py         | Stanford. Programming not prompting. Auto-optimizes.                        |
| [Mastra](https://github.com/mastra-ai/mastra) ⭐ 28,244 \| 🐛 565 \| 🌐 TypeScript \| 📅 2026-09-21                  | TS         | TypeScript-first. Observational Memory. Apache 2.0.                         |
| [Anthropic SDK](https://github.com/anthropics/anthropic-sdk-python) ⭐ 3,911 \| 🐛 175 \| 🌐 Python \| 📅 2026-09-18 | Py/TS      | Official Claude SDK. Tool use, computer control, streaming.                 |
| [Google ADK](https://github.com/google/adk-python) ⭐ 21,591 \| 🐛 500 \| 🌐 Python \| 📅 2026-09-21                 | Py         | ⭐ Google's Agent Development Kit. Native Gemini. Multi-agent orchestration. |

### Multi-Agent Orchestration

| Framework                                                                                                           | Lang               | Description                                                                                                            |
| ------------------------------------------------------------------------------------------------------------------- | ------------------ | ---------------------------------------------------------------------------------------------------------------------- |
| [AutoGen](https://github.com/microsoft/autogen) ⭐ 61,099 \| 🐛 1,089 \| 🌐 Python \| 📅 2026-04-15                  | Py                 | Microsoft multi-agent conversations.                                                                                   |
| [CrewAI](https://github.com/crewAIInc/crewAI) ⭐ 58,868 \| 🐛 449 \| 🌐 Python \| 📅 2026-09-21                      | Py                 | Role-based crew members with goals and tools. Used by 60%+ Fortune 500.                                                |
| [MetaGPT](https://github.com/geekan/MetaGPT) ⭐ 70,544 \| 🐛 135 \| 🌐 Python \| 📅 2026-01-21                       | Py                 | PM, architect, engineer roles. Software company sim.                                                                   |
...
| [OpenAI Agents SDK](https://github.com/openai/openai-agents-python) ⭐ 29,615 \| 🐛 46 \| 🌐 Python \| 📅 2026-09-21 | Py                 | Official. Multi-step agents with handoffs.                                                                             |
| [Strands Agents](https://github.com/strands-agents/sdk-python) ⭐ 7,402 \| 🐛 792 \| 🌐 Python \| 📅 2026-09-21      | Py                 | AWS-backed. Model-driven tool use.                                                                                     |
| [CAMEL](https://github.com/camel-ai/camel) ⭐ 17,749 \| 🐛 496 \| 🌐 Python \| 📅 2026-09-20                         | Py                 | Role-based simulation. Collaborative reasoning.                                                                        |
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) ⭐ 187,481 \| 🐛 575 \| 🌐 Python \| 📅 2026-09-21        | Py                 | Pioneer. Now full platform with visual builder.                                                                        |
| [Bernstein](https://github.com/chernistry/bernstein) ⭐ 1,237 \| 🐛 416 \| 🌐 Python \| 📅 2026-09-21                | Py                 | Deterministic orchestrator. Parallel coding agents, test-driven verification. Zero LLM tokens on coordination.         |
| [AgentScope](https://github.com/modelscope/agentscope) ⭐ 32,126 \| 🐛 416 \| 🌐 Python \| 📅 2026-09-21             | Py                 | Alibaba multi-agent framework.                                                                                         |
...
| [DeerFlow](https://github.com/bytedance/deer-flow) ⭐ 82,814 \| 🐛 911 \| 🌐 Python \| 📅 2026-09-21                 | Py                 | ByteDance. No.1 GitHub Trending Feb 2026. 25k+ stars.                                                                  |
...
| Framework                                                                                                | Lang | Description                               |
| -------------------------------------------------------------------------------------------------------- | ---- | ----------------------------------------- |
| [Smolagents](https://github.com/huggingface/smolagents) ⭐ 29,433 \| 🐛 818 \| 🌐 Python \| 📅 2026-08-25 | Py   | HuggingFace minimal agents. \~1000 lines. |
| [Agno](https://github.com/agno-agi/agno) ⭐ 42,281 \| 🐛 1,554 \| 🌐 Python \| 📅 2026-09-21              | Py   | Lightweight, model-agnostic.              |
| [Upsonic](https://github.com/upsonic/upsonic) ⭐ 7,958 \| 🐛 34 \| 🌐 Python \| 📅 2026-06-18             | Py   | MCP support. Minimal setup.               |
...
| --------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [OpenClaw Agent Templates](https://github.com/mergisi/awesome-openclaw-agents) ⭐ 3,977 \| 🐛 89 \| 🌐 HTML \| 📅 2026-05-25 | 177 production-ready SOUL.md configs across 24 categories (PM, SEO, DevOps, Writer, Support). Copy-paste ready for [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 390,214 \| 🐛 8,367 \| 🌐 TypeScript \| 📅 2026-09-21. Visual deploy via [CrewClaw](https://crewclaw.com). |
...
| Tool                                                                                                             | Description                                                                                                                                      |
| ---------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Browser Use](https://github.com/browser-use/browser-use) ⭐ 115,765 \| 🐛 476 \| 🌐 Python \| 📅 2026-09-18      | OSS browser agent library. Used by Manus.                                                                                                        |
| [Skyvern](https://github.com/Skyvern-AI/skyvern) ⭐ 23,046 \| 🐛 248 \| 🌐 Python \| 📅 2026-09-21                | Vision-driven. GPT-4V navigation without coded selectors.                                                                                        |
| [Agent S2 (Simular)](https://github.com/simular-ai/Agent-S) ⭐ 12,338 \| 🐛 43 \| 🌐 Python \| 📅 2026-09-05      | OSS GUI automation framework.                                                                                                                    |
...
| [Plasmate](https://github.com/plasmate-labs/plasmate) ⭐ 37 \| 🐛 2 \| 🌐 Rust \| 📅 2026-09-21                   | Headless browser compiling HTML to structured JSON (SOM). 17.5x compression, 13 MCP tools. First browser tool on MCP Registry. Rust, Apache-2.0. |
| [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 37,445 \| 🐛 4 \| 🌐 TypeScript \| 📅 2026-09-18 | MCP server for Playwright + AI agents.                                                                                                           |
...
| Tool                                                                                                 | Description                                       |
| ---------------------------------------------------------------------------------------------------- | ------------------------------------------------- |
| [LiveKit Agents](https://github.com/livekit/agents) ⭐ 14,302 \| 🐛 842 \| 🌐 Python \| 📅 2026-09-21 | OSS real-time voice/video AI agents.              |
| [Rasa](https://github.com/RasaHQ/rasa) ⭐ 21,326 \| 🐛 153 \| 🌐 Python \| 📅 2026-07-24              | OSS conversational AI. Self-hosted. NLU training. |
| [Pipecat](https://github.com/pipecat-ai/pipecat) ⭐ 15,744 \| 🐛 347 \| 🌐 Python \| 📅 2026-09-21    | OSS voice and multimodal conversational AI.       |
| [Vocode](https://github.com/vocodedev/vocode-python) ⭐ 3,794 \| 🐛 0 \| 🌐 Python \| 📅 2024-11-15   | OSS voice-based LLM agents.                       |
...
| [InkOS](https://github.com/Narcooo/inkos) ⭐ 10,006 \| 🐛 237 \| 🌐 TypeScript \| 📅 2026-08-25 | Autonomous novel-writing CLI agent. Agents collaborate to produce long-form fiction with continuity auditing, anti-AI-slop filtering, and style cloning. | Free / OSS     |
...
| [Wan 2.1](https://github.com/Wan-Video/Wan2.1) ⭐ 17,022 \| 🐛 383 \| 🌐 Python \| 📅 2026-03-05          | Best free OSS video gen. Self-hostable. No limits.                                 | Free (OSS)       |
| [HunyuanVideo](https://github.com/Tencent/HunyuanVideo) ⭐ 12,554 \| 🐛 185 \| 🌐 Python \| 📅 2026-06-29 | Tencent OSS. Consumer GPU. Multi-style.                                            | Free (OSS)       |
| [LTX Video](https://github.com/Lightricks/LTX-Video) ⭐ 10,969 \| 🐛 99 \| 🌐 Python \| 📅 2026-01-05     | OSS. Licensed data. Clear commercial terms.                                        | Free (OSS)       |
...
| Agent                                                                                                             | Description                                                                                                                              | Pricing        |
| ----------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- | -------------- |
| [n8n](https://github.com/n8n-io/n8n) ⭐ 205,597 \| 🐛 1,180 \| 🌐 TypeScript \| 📅 2026-09-21                      | OSS workflow automation with AI agent nodes. Visual + code.                                                                              | Free / Cloud   |
...
| [Activepieces](https://github.com/activepieces/activepieces) ⭐ 24,640 \| 🐛 587 \| 🌐 TypeScript \| 📅 2026-09-21 | OSS Zapier alternative with AI.                                                                                                          | Free (OSS)     |
| [Temporal](https://github.com/temporalio/temporal) ⭐ 23,216 \| 🐛 993 \| 🌐 Go \| 📅 2026-09-21                   | Durable execution for long-running agent workflows.                                                                                      | Free / Cloud   |
...
| Agent                                                                                                   | Description                                                                                                                                            | Pricing      |
| ------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------ |
| [Dify](https://github.com/langgenius/dify) ⭐ 156,763 \| 🐛 1,094 \| 🌐 TypeScript \| 📅 2026-09-21      | OSS LLMOps. Visual agent builder. RAG. 130k+ stars.                                                                                                    | Free / Cloud |
| [Flowise](https://github.com/FlowiseAI/Flowise) ⚠️ Archived                                             | OSS drag-and-drop LLM agent builder.                                                                                                                   | Free (OSS)   |
| [Langflow](https://github.com/langflow-ai/langflow) ⭐ 155,105 \| 🐛 1,100 \| 🌐 Python \| 📅 2026-09-21 | Visual multi-agent and RAG builder.                                                                                                                    | Free / Cloud |
...
| [FastAgency](https://github.com/airtai/fastagency) ⭐ 548 \| 🐛 80 \| 🌐 Python \| 📅 2026-02-23         | Deploy multi-agent workflows as APIs.                                                                                                                  | Free (OSS)   |
...
| [DeerFlow](https://github.com/bytedance/deer-flow) ⭐ 82,814 \| 🐛 911 \| 🌐 Python \| 📅 2026-09-21              | ByteDance OSS. Planning, tools, memory, execution.            | Free (OSS)      |
| [GPT Researcher](https://github.com/assafelovic/gpt-researcher) ⭐ 29,557 \| 🐛 102 \| 🌐 Python \| 📅 2026-08-27 | OSS autonomous comprehensive research.                        | Free (OSS)      |
| [STORM](https://github.com/stanford-oval/storm) ⭐ 31,456 \| 🐛 109 \| 🌐 Python \| 📅 2025-09-30                 | Stanford. Writes Wikipedia-like articles from scratch.        | Free (OSS)      |
...
| Tool                                                                                                                                                                                                                                                                                                                                                                    | Description                                                                             |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| [RAGFlow](https://github.com/infiniflow/ragflow) ⭐ 91,106 \| 🐛 1,470 \| 🌐 Go \| 📅 2026-09-21                                                                                                                                                                                                                                                                         | OSS RAG engine with agent capabilities.                                                 |
...
| [Pathway](https://github.com/pathwaycom/pathway) ⭐ 62,253 \| 🐛 37 \| 🌐 Python \| 📅 2026-09-21                                                                                                                                                                                                                                                                        | Live data RAG. Real-time streaming. 50k+ stars.                                         |
| [Mem0](https://github.com/mem0ai/mem0) ⭐ 65,789 \| 🐛 766 \| 🌐 Python \| 📅 2026-09-21                                                                                                                                                                                                                                                                                 | Memory layer for agents. Long-term across sessions.                                     |
...
| [Chroma](https://github.com/chroma-core/chroma) ⭐ 29,349 \| 🐛 881 \| 🌐 Rust \| 📅 2026-09-21                                                                                                                                                                                                                                                                          | OSS embedding database. Fastest way to build RAG.                                       |
| [Weaviate](https://github.com/weaviate/weaviate) ⭐ 16,834 \| 🐛 749 \| 🌐 Go \| 📅 2026-09-21                                                                                                                                                                                                                                                                           | OSS vector DB. GraphQL. Multi-modal search.                                             |
| [Qdrant](https://github.com/qdrant/qdrant) ⭐ 34,736 \| 🐛 752 \| 🌐 Rust \| 📅 2026-09-21                                                                                                                                                                                                                                                                               | High-performance vector DB in Rust.                                                     |
| [Milvus](https://github.com/milvus-io/milvus) ⭐ 46,194 \| 🐛 1,461 \| 🌐 Go \| 📅 2026-09-21                                                                                                                                                                                                                                                                            | Cloud-native vector DB. Billion-scale.                                                  |
...
| Tool                                                                                                 | Description                                                       |
| ---------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| [Ollama](https://github.com/ollama/ollama) ⭐ 181,397 \| 🐛 4,057 \| 🌐 Go \| 📅 2026-09-21           | Run LLMs locally. 162k+ stars. Dead simple CLI.                   |
| [llama.cpp](https://github.com/ggml-org/llama.cpp) ⭐ 129,090 \| 🐛 2,533 \| 🌐 C++ \| 📅 2026-09-21  | C/C++ inference. CPU, GPU, Apple Silicon. Foundation of local AI. |
| [vLLM](https://github.com/vllm-project/vllm) ⭐ 92,357 \| 🐛 8,266 \| 🌐 Python \| 📅 2026-09-21      | High-throughput serving. PagedAttention. Production-grade.        |
| [LM Studio](https://lmstudio.ai)                                                                     | Desktop app for local LLMs. Beautiful UI. All platforms.          |
| [Jan](https://github.com/janhq/jan) ⭐ 44,587 \| 🐛 538 \| 🌐 Rust \| 📅 2026-09-21                   | OSS ChatGPT alternative. 100% offline.                            |
| [LocalAI](https://github.com/mudler/LocalAI) ⭐ 49,207 \| 🐛 167 \| 🌐 Go \| 📅 2026-09-21            | Drop-in OpenAI API replacement. No GPU required.                  |
...
| [Llamafile](https://github.com/Mozilla-Ocho/llamafile) ⭐ 26,018 \| 🐛 212 \| 🌐 C++ \| 📅 2026-09-16 | LLMs as single files. Zero setup. Mozilla.                        |

### Self-Hosted Agents and UIs

| Tool                                                                                                               | Description                                                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Open WebUI](https://github.com/open-webui/open-webui) ⭐ 152,728 \| 🐛 276 \| 🌐 Python \| 📅 2026-09-21           | Self-hosted ChatGPT UI. Access control. Extensions.                                                                                                                                                            |
| [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 390,214 \| 🐛 8,367 \| 🌐 TypeScript \| 📅 2026-09-21           | Fastest-growing GitHub repo ever (9k to 188k stars in 60 days). Self-hosted agent across WhatsApp, Telegram, Slack, Discord, Signal. 5,700+ community skills.                                                  |
...
| [LibreChat](https://github.com/danny-avila/LibreChat) ⭐ 44,576 \| 🐛 770 \| 🌐 TypeScript \| 📅 2026-09-21         | Self-hosted multi-model chat. All major providers.                                                                                                                                                             |
| [LobeChat](https://github.com/lobehub/lobe-chat) ⭐ 82,730 \| 🐛 944 \| 🌐 TypeScript \| 📅 2026-09-21              | OSS ChatGPT/Gemini UI. Plugin system. Multi-modal.                                                                                                                                                             |
...
| [Anything LLM](https://github.com/Mintplex-Labs/anything-llm) ⭐ 66,307 \| 🐛 326 \| 🌐 JavaScript \| 📅 2026-09-21 | All-in-one AI app. RAG, agents. Desktop + Docker.                                                                                                                                                              |
| [DB-GPT](https://github.com/eosphoros-ai/DB-GPT) ⭐ 20,025 \| 🐛 451 \| 🌐 Python \| 📅 2026-09-16                  | Data interaction with local LLM. 100% private.                                                                                                                                                                 |
...
| [A2A (Agent-to-Agent)](https://github.com/google/A2A) ⭐ 25,882 \| 🐛 262 \| 🌐 Shell \| 📅 2026-09-21     | Google protocol for inter-agent communication. Horizontal agent collaboration.                                                                     |
...
| [OpenAPI](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,227 \| 🐛 80 \| 🌐 Markdown \| 📅 2026-09-11 | Industry-standard API spec. Foundation for agent tools.                                                                                            |
...
| Tool                                                                                            | Description                                                                                                                                                                            |
| ----------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Entroly](https://github.com/juyterman1000/entroly) ⭐ 465 \| 🐛 0 \| 🌐 Python \| 📅 2026-09-21 | Context engineering engine. 100% codebase visibility with 78% fewer tokens. Knapsack-optimal selection, SimHash dedup, RL from response quality. Rust engine, <10ms. MCP + HTTP proxy. |

### Tracing and Monitoring

| Tool                                                                                                     | Description                                                                                                                          |
| -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| [Langfuse](https://github.com/langfuse/langfuse) ⭐ 34,908 \| 🐛 921 \| 🌐 TypeScript \| 📅 2026-09-21    | OSS LLM observability. Traces, evals, prompts.                                                                                       |
...
| [Arize Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,563 \| 🐛 1,035 \| 🌐 Python \| 📅 2026-09-21  | OSS AI observability. Traces, evals, embeddings.                                                                                     |
| [Helicone](https://github.com/Helicone/helicone) ⭐ 6,170 \| 🐛 159 \| 🌐 TypeScript \| 📅 2026-09-16     | OSS LLM observability. One-line integration.                                                                                         |
...
| ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------ |
| [SWE-bench](https://github.com/princeton-nlp/SWE-bench) ⭐ 5,887 \| 🐛 16 \| 🌐 Python \| 📅 2026-09-18 | Industry standard for coding agents. Top: 80.9% (Claude Opus 4.6). |
...
| [WebArena](https://github.com/web-arena-x/webarena) ⭐ 1,611 \| 🐛 103 \| 🌐 Python \| 📅 2025-11-26    | Web agent benchmark. Real websites.                                |
...
| [Qwen3.6-Plus](https://github.com/QwenLM/Qwen3) ⭐ 27,650 \| 🐛 68 \| 🌐 Python \| 📅 2026-01-09                | Alibaba   | Various   | ⭐ **NEW (Apr 2026)** Agentic focus. 1M ctx. Repo-level coding. MCP-native. |
| [Qwen3.5-Omni](https://github.com/QwenLM/Qwen3) ⭐ 27,650 \| 🐛 68 \| 🌐 Python \| 📅 2026-01-09                | Alibaba   | 397B MoE  | Native multimodal. Text, image, audio.                                     |
| [DeepSeek V3/R1](https://github.com/deepseek-ai/DeepSeek-V3) ⭐ 104,475 \| 🐛 250 \| 🌐 Python \| 📅 2025-08-28 | DeepSeek  | 671B MoE  | 68x cheaper. Strong reasoning. V4 Lite in preview.                         |
| [Gemma 4](https://github.com/google-deepmind/gemma) ⭐ 5,742 \| 🐛 331 \| 🌐 Python \| 📅 2026-09-16            | Google    | 2B-31B    | ⭐ **NEW (Apr 2026)** Consumer/IoT optimized. E2B, E4B variants.            |
| [GLM-4](https://github.com/THUDM/GLM-4) ⭐ 7,072 \| 🐛 41 \| 🌐 Python \| 📅 2026-08-05                         | Zhipu     | 744B MoE  | Lowest hallucination rate. 77.8% SWE-bench.                                |
...
| Tool                                                                                                         | Description                                                                      |
| ------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------- |
| [Guardrails AI](https://github.com/guardrails-ai/guardrails) ⭐ 7,440 \| 🐛 80 \| 🌐 Python \| 📅 2026-09-18  | Structural, type, quality guarantees for LLM outputs.                            |
| [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) ⭐ 7,179 \| 🐛 233 \| 🌐 Python \| 📅 2026-09-21 | NVIDIA. Programmable conversation guardrails.                                    |
...
| [PentestGPT](https://github.com/GreyDGL/PentestGPT) ⭐ 15,554 \| 🐛 86 \| 🌐 Python \| 📅 2026-07-14         | GPT-powered pentesting. Automated reasoning.                                                                                |
...
* [Microsoft GenAI for Beginners](https://github.com/microsoft/generative-ai-for-beginners) ⭐ 120,202 | 🐛 6 | 🌐 Jupyter Notebook | 📅 2026-09-18 - 21-lesson course
* [OpenAI Cookbook](https://github.com/openai/openai-cookbook) ⭐ 76,111 | 🐛 303 | 🌐 Jupyter Notebook | 📅 2026-09-21 - Practical API guides
* [Anthropic Cookbook](https://github.com/anthropics/anthropic-cookbook) ⭐ 52,872 | 🐛 339 | 🌐 Jupyter Notebook | 📅 2026-09-21 - Claude agent recipes
