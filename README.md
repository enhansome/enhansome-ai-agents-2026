...
[![Stars](https://img.shields.io/github/stars/caramaschiHG/awesome-ai-agents-2026?style=flat-square\&color=yellow)](https://github.com/caramaschiHG/awesome-ai-agents-2026/stargazers) ⭐ 1,899 | 🐛 410 | 📅 2026-06-10
...
| [OpenAI Codex CLI](https://github.com/openai/codex) ⭐ 126,339 \| 🐛 18,629 \| 🌐 Rust \| 📅 2026-09-24          | OpenAI terminal agent. Agents SDK. Multi-agent.                                                                             | ChatGPT sub            |
| [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 107,149 \| 🐛 829 \| 🌐 TypeScript \| 📅 2026-09-24 | ⭐ **NEW (Apr 2026)** Google's official open-source terminal agent. ReAct loop. MCP support. 1M context. Apache 2.0.         | Free w/ Google account |
| [Aider](https://github.com/paul-gauthier/aider) ⭐ 49,159 \| 🐛 1,891 \| 🌐 Python \| 📅 2026-05-22              | OSS pair programmer. Git-aware. Any LLM.                                                                                    | Free + API             |
| [Cline](https://github.com/cline/cline) ⭐ 69,235 \| 🐛 1,439 \| 🌐 TypeScript \| 📅 2026-09-24                  | VS Code extension. Full terminal and browser access for Claude/GPT.                                                         | Free + API             |
...
| [Caliber](https://github.com/caliber-ai-org/ai-setup) ⭐ 1,283 \| 🐛 18 \| 🌐 TypeScript \| 📅 2026-09-24        | CLI that fingerprints projects and generates/syncs AI agent configs (CLAUDE.md, .cursor/rules/, AGENTS.md). Scores quality. | Free + API             |
...
| [SWE-Agent](https://github.com/princeton-nlp/SWE-agent) ⭐ 20,397 \| 🐛 119 \| 🌐 Python \| 📅 2026-09-21    | Princeton. Resolves real GitHub issues autonomously.                                   | Free (OSS)   |
| [OpenHands](https://github.com/All-Hands-AI/OpenHands) ⭐ 89,088 \| 🐛 875 \| 🌐 TypeScript \| 📅 2026-09-24 | OSS autonomous software engineer (ex-OpenDevin).                                       | Free (OSS)   |
...
| [PR-Agent](https://github.com/Codium-ai/pr-agent) ⭐ 13,141 \| 🐛 49 \| 🌐 Python \| 📅 2026-09-24 | OSS AI PR reviewer. Auto-describe, review, improve. | Free (OSS)        |
...
| [Dyad](https://github.com/dyad-sh/dyad) ⭐ 21,605 \| 🐛 341 \| 🌐 TypeScript \| 📅 2026-09-24 | OSS. Local-first. No-code app builder.     | Free (OSS)    |
...
| ------------------------------------------------------------------------------------------------------------------- | ---------- | --------------------------------------------------------------------------- |
| [LangChain](https://github.com/langchain-ai/langchain) ⭐ 147,002 \| 🐛 569 \| 🌐 Python \| 📅 2026-09-24            | Py/JS      | Most adopted. Modular architecture, memory, tools.                          |
| [LangGraph](https://github.com/langchain-ai/langgraph) ⭐ 42,237 \| 🐛 818 \| 🌐 Python \| 📅 2026-09-23             | Py/JS      | Graph-based orchestration. Stateful directed graphs.                        |
| [LlamaIndex](https://github.com/run-llama/llama_index) ⭐ 52,307 \| 🐛 857 \| 🌐 Python \| 📅 2026-09-24             | Py/JS      | Data-focused. Best for RAG agents.                                          |
| [Haystack](https://github.com/deepset-ai/haystack) ⭐ 26,591 \| 🐛 155 \| 🌐 Python \| 📅 2026-09-24                 | Py         | Pipeline-based. Search and retrieval.                                       |
| [Semantic Kernel](https://github.com/microsoft/semantic-kernel) ⭐ 28,599 \| 🐛 322 \| 🌐 C# \| 📅 2026-09-19        | C#/Py/Java | Microsoft enterprise. Azure integration.                                    |
| [Pydantic AI](https://github.com/pydantic/pydantic-ai) ⭐ 20,153 \| 🐛 970 \| 🌐 Python \| 📅 2026-09-24             | Py         | Type-safe. Clean Pythonic API. Production-ready.                            |
| [DSPy](https://github.com/stanfordnlp/dspy) ⭐ 38,261 \| 🐛 729 \| 🌐 Python \| 📅 2026-09-24                        | Py         | Stanford. Programming not prompting. Auto-optimizes.                        |
| [Mastra](https://github.com/mastra-ai/mastra) ⭐ 28,316 \| 🐛 473 \| 🌐 TypeScript \| 📅 2026-09-24                  | TS         | TypeScript-first. Observational Memory. Apache 2.0.                         |
| [Anthropic SDK](https://github.com/anthropics/anthropic-sdk-python) ⭐ 3,920 \| 🐛 178 \| 🌐 Python \| 📅 2026-09-22 | Py/TS      | Official Claude SDK. Tool use, computer control, streaming.                 |
| [Google ADK](https://github.com/google/adk-python) ⭐ 21,630 \| 🐛 504 \| 🌐 Python \| 📅 2026-09-24                 | Py         | ⭐ Google's Agent Development Kit. Native Gemini. Multi-agent orchestration. |

### Multi-Agent Orchestration

| Framework                                                                                                           | Lang               | Description                                                                                                            |
| ------------------------------------------------------------------------------------------------------------------- | ------------------ | ---------------------------------------------------------------------------------------------------------------------- |
| [AutoGen](https://github.com/microsoft/autogen) ⭐ 61,146 \| 🐛 1,099 \| 🌐 Python \| 📅 2026-04-15                  | Py                 | Microsoft multi-agent conversations.                                                                                   |
| [CrewAI](https://github.com/crewAIInc/crewAI) ⭐ 58,985 \| 🐛 475 \| 🌐 Python \| 📅 2026-09-23                      | Py                 | Role-based crew members with goals and tools. Used by 60%+ Fortune 500.                                                |
| [MetaGPT](https://github.com/geekan/MetaGPT) ⭐ 70,595 \| 🐛 139 \| 🌐 Python \| 📅 2026-01-21                       | Py                 | PM, architect, engineer roles. Software company sim.                                                                   |
...
| [OpenAI Agents SDK](https://github.com/openai/openai-agents-python) ⭐ 29,682 \| 🐛 52 \| 🌐 Python \| 📅 2026-09-24 | Py                 | Official. Multi-step agents with handoffs.                                                                             |
| [Strands Agents](https://github.com/strands-agents/sdk-python) ⭐ 8,211 \| 🐛 822 \| 🌐 Python \| 📅 2026-09-24      | Py                 | AWS-backed. Model-driven tool use.                                                                                     |
| [CAMEL](https://github.com/camel-ai/camel) ⭐ 17,769 \| 🐛 514 \| 🌐 Python \| 📅 2026-09-20                         | Py                 | Role-based simulation. Collaborative reasoning.                                                                        |
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) ⭐ 187,525 \| 🐛 537 \| 🌐 Python \| 📅 2026-09-24        | Py                 | Pioneer. Now full platform with visual builder.                                                                        |
| [Bernstein](https://github.com/chernistry/bernstein) ⭐ 1,265 \| 🐛 351 \| 🌐 Python \| 📅 2026-09-24                | Py                 | Deterministic orchestrator. Parallel coding agents, test-driven verification. Zero LLM tokens on coordination.         |
| [AgentScope](https://github.com/modelscope/agentscope) ⭐ 32,305 \| 🐛 434 \| 🌐 Python \| 📅 2026-09-24             | Py                 | Alibaba multi-agent framework.                                                                                         |
...
| [DeerFlow](https://github.com/bytedance/deer-flow) ⭐ 82,944 \| 🐛 892 \| 🌐 Python \| 📅 2026-09-24                 | Py                 | ByteDance. No.1 GitHub Trending Feb 2026. 25k+ stars.                                                                  |
...
| Framework                                                                                                | Lang | Description                               |
| -------------------------------------------------------------------------------------------------------- | ---- | ----------------------------------------- |
| [Smolagents](https://github.com/huggingface/smolagents) ⭐ 29,478 \| 🐛 827 \| 🌐 Python \| 📅 2026-09-23 | Py   | HuggingFace minimal agents. \~1000 lines. |
| [Agno](https://github.com/agno-agi/agno) ⭐ 42,330 \| 🐛 1,617 \| 🌐 Python \| 📅 2026-09-24              | Py   | Lightweight, model-agnostic.              |
...
| --------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [OpenClaw Agent Templates](https://github.com/mergisi/awesome-openclaw-agents) ⭐ 3,983 \| 🐛 88 \| 🌐 HTML \| 📅 2026-05-25 | 177 production-ready SOUL.md configs across 24 categories (PM, SEO, DevOps, Writer, Support). Copy-paste ready for [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 390,403 \| 🐛 8,570 \| 🌐 TypeScript \| 📅 2026-09-24. Visual deploy via [CrewClaw](https://crewclaw.com). |
...
| Tool                                                                                                             | Description                                                                                                                                      |
| ---------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Browser Use](https://github.com/browser-use/browser-use) ⭐ 116,197 \| 🐛 491 \| 🌐 Python \| 📅 2026-09-24      | OSS browser agent library. Used by Manus.                                                                                                        |
| [Skyvern](https://github.com/Skyvern-AI/skyvern) ⭐ 23,060 \| 🐛 254 \| 🌐 Python \| 📅 2026-09-24                | Vision-driven. GPT-4V navigation without coded selectors.                                                                                        |
| [Agent S2 (Simular)](https://github.com/simular-ai/Agent-S) ⭐ 12,367 \| 🐛 43 \| 🌐 Python \| 📅 2026-09-05      | OSS GUI automation framework.                                                                                                                    |
...
| [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 37,543 \| 🐛 7 \| 🌐 TypeScript \| 📅 2026-09-18 | MCP server for Playwright + AI agents.                                                                                                           |
...
| Tool                                                                                                 | Description                                       |
| ---------------------------------------------------------------------------------------------------- | ------------------------------------------------- |
| [LiveKit Agents](https://github.com/livekit/agents) ⭐ 14,343 \| 🐛 860 \| 🌐 Python \| 📅 2026-09-24 | OSS real-time voice/video AI agents.              |
| [Rasa](https://github.com/RasaHQ/rasa) ⭐ 21,329 \| 🐛 153 \| 🌐 Python \| 📅 2026-07-24              | OSS conversational AI. Self-hosted. NLU training. |
| [Pipecat](https://github.com/pipecat-ai/pipecat) ⭐ 15,829 \| 🐛 366 \| 🌐 Python \| 📅 2026-09-24    | OSS voice and multimodal conversational AI.       |
...
| [InkOS](https://github.com/Narcooo/inkos) ⭐ 10,035 \| 🐛 236 \| 🌐 TypeScript \| 📅 2026-08-25 | Autonomous novel-writing CLI agent. Agents collaborate to produce long-form fiction with continuity auditing, anti-AI-slop filtering, and style cloning. | Free / OSS     |
...
| [Wan 2.1](https://github.com/Wan-Video/Wan2.1) ⭐ 17,044 \| 🐛 383 \| 🌐 Python \| 📅 2026-03-05          | Best free OSS video gen. Self-hostable. No limits.                                 | Free (OSS)       |
| [HunyuanVideo](https://github.com/Tencent/HunyuanVideo) ⭐ 12,568 \| 🐛 185 \| 🌐 Python \| 📅 2026-06-29 | Tencent OSS. Consumer GPU. Multi-style.                                            | Free (OSS)       |
| [LTX Video](https://github.com/Lightricks/LTX-Video) ⭐ 10,982 \| 🐛 100 \| 🌐 Python \| 📅 2026-01-05    | OSS. Licensed data. Clear commercial terms.                                        | Free (OSS)       |
...
| Agent                                                                                                             | Description                                                                                                                              | Pricing        |
| ----------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- | -------------- |
| [n8n](https://github.com/n8n-io/n8n) ⭐ 205,882 \| 🐛 1,163 \| 🌐 TypeScript \| 📅 2026-09-24                      | OSS workflow automation with AI agent nodes. Visual + code.                                                                              | Free / Cloud   |
...
| [Activepieces](https://github.com/activepieces/activepieces) ⭐ 24,717 \| 🐛 593 \| 🌐 TypeScript \| 📅 2026-09-24 | OSS Zapier alternative with AI.                                                                                                          | Free (OSS)     |
| [Temporal](https://github.com/temporalio/temporal) ⭐ 23,278 \| 🐛 1,003 \| 🌐 Go \| 📅 2026-09-24                 | Durable execution for long-running agent workflows.                                                                                      | Free / Cloud   |
| [Mission Control](https://github.com/MeisnerDan/mission-control) ⭐ 950 \| 🐛 17 \| 🌐 TypeScript \| 📅 2026-04-01 | Cockpit for the agentic era — manage AI agent swarms with autonomous daemon, Field Ops for real-world execution, and approval workflows. | Free (OSS)     |

### No-Code Agent Builders

| Agent                                                                                                   | Description                                                                                                                                            | Pricing      |
| ------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------ |
| [Dify](https://github.com/langgenius/dify) ⭐ 157,112 \| 🐛 1,105 \| 🌐 TypeScript \| 📅 2026-09-24      | OSS LLMOps. Visual agent builder. RAG. 130k+ stars.                                                                                                    | Free / Cloud |
| [Flowise](https://github.com/FlowiseAI/Flowise) ⚠️ Archived                                             | OSS drag-and-drop LLM agent builder.                                                                                                                   | Free (OSS)   |
| [Langflow](https://github.com/langflow-ai/langflow) ⭐ 155,218 \| 🐛 1,186 \| 🌐 Python \| 📅 2026-09-24 | Visual multi-agent and RAG builder.                                                                                                                    | Free / Cloud |
...
| [FastAgency](https://github.com/airtai/fastagency) ⭐ 549 \| 🐛 80 \| 🌐 Python \| 📅 2026-02-23         | Deploy multi-agent workflows as APIs.                                                                                                                  | Free (OSS)   |
...
| [DeerFlow](https://github.com/bytedance/deer-flow) ⭐ 82,944 \| 🐛 892 \| 🌐 Python \| 📅 2026-09-24              | ByteDance OSS. Planning, tools, memory, execution.            | Free (OSS)      |
| [GPT Researcher](https://github.com/assafelovic/gpt-researcher) ⭐ 29,608 \| 🐛 108 \| 🌐 Python \| 📅 2026-08-27 | OSS autonomous comprehensive research.                        | Free (OSS)      |
| [STORM](https://github.com/stanford-oval/storm) ⭐ 31,502 \| 🐛 110 \| 🌐 Python \| 📅 2025-09-30                 | Stanford. Writes Wikipedia-like articles from scratch.        | Free (OSS)      |
...
| Tool                                                                                                                                                                                                                                                                                                                                                                    | Description                                                                             |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| [RAGFlow](https://github.com/infiniflow/ragflow) ⭐ 91,275 \| 🐛 1,500 \| 🌐 Go \| 📅 2026-09-24                                                                                                                                                                                                                                                                         | OSS RAG engine with agent capabilities.                                                 |
...
| [Pathway](https://github.com/pathwaycom/pathway) ⭐ 62,243 \| 🐛 38 \| 🌐 Python \| 📅 2026-09-24                                                                                                                                                                                                                                                                        | Live data RAG. Real-time streaming. 50k+ stars.                                         |
| [Mem0](https://github.com/mem0ai/mem0) ⭐ 65,948 \| 🐛 764 \| 🌐 Python \| 📅 2026-09-24                                                                                                                                                                                                                                                                                 | Memory layer for agents. Long-term across sessions.                                     |
...
| [Chroma](https://github.com/chroma-core/chroma) ⭐ 29,368 \| 🐛 887 \| 🌐 Rust \| 📅 2026-09-24                                                                                                                                                                                                                                                                          | OSS embedding database. Fastest way to build RAG.                                       |
| [Weaviate](https://github.com/weaviate/weaviate) ⭐ 16,842 \| 🐛 741 \| 🌐 Go \| 📅 2026-09-24                                                                                                                                                                                                                                                                           | OSS vector DB. GraphQL. Multi-modal search.                                             |
| [Qdrant](https://github.com/qdrant/qdrant) ⭐ 34,796 \| 🐛 755 \| 🌐 Rust \| 📅 2026-09-24                                                                                                                                                                                                                                                                               | High-performance vector DB in Rust.                                                     |
| [Milvus](https://github.com/milvus-io/milvus) ⭐ 46,248 \| 🐛 1,473 \| 🌐 Go \| 📅 2026-09-24                                                                                                                                                                                                                                                                            | Cloud-native vector DB. Billion-scale.                                                  |
...
| Tool                                                                                                 | Description                                                       |
| ---------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| [Ollama](https://github.com/ollama/ollama) ⭐ 181,630 \| 🐛 4,072 \| 🌐 Go \| 📅 2026-09-24           | Run LLMs locally. 162k+ stars. Dead simple CLI.                   |
| [llama.cpp](https://github.com/ggml-org/llama.cpp) ⭐ 129,441 \| 🐛 2,531 \| 🌐 C++ \| 📅 2026-09-24  | C/C++ inference. CPU, GPU, Apple Silicon. Foundation of local AI. |
| [vLLM](https://github.com/vllm-project/vllm) ⭐ 92,638 \| 🐛 8,404 \| 🌐 Python \| 📅 2026-09-24      | High-throughput serving. PagedAttention. Production-grade.        |
| [LM Studio](https://lmstudio.ai)                                                                     | Desktop app for local LLMs. Beautiful UI. All platforms.          |
| [Jan](https://github.com/janhq/jan) ⭐ 44,637 \| 🐛 546 \| 🌐 Rust \| 📅 2026-09-24                   | OSS ChatGPT alternative. 100% offline.                            |
| [LocalAI](https://github.com/mudler/LocalAI) ⭐ 49,259 \| 🐛 158 \| 🌐 Go \| 📅 2026-09-24            | Drop-in OpenAI API replacement. No GPU required.                  |
...
| [GPT4All](https://github.com/nomic-ai/gpt4all) ⭐ 77,384 \| 🐛 773 \| 🌐 C++ \| 📅 2025-05-27         | OSS local chat. Consumer hardware.                                |
| [Llamafile](https://github.com/Mozilla-Ocho/llamafile) ⭐ 26,052 \| 🐛 214 \| 🌐 C++ \| 📅 2026-09-24 | LLMs as single files. Zero setup. Mozilla.                        |

### Self-Hosted Agents and UIs

| Tool                                                                                                               | Description                                                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Open WebUI](https://github.com/open-webui/open-webui) ⭐ 153,064 \| 🐛 303 \| 🌐 Python \| 📅 2026-09-24           | Self-hosted ChatGPT UI. Access control. Extensions.                                                                                                                                                            |
| [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 390,403 \| 🐛 8,570 \| 🌐 TypeScript \| 📅 2026-09-24           | Fastest-growing GitHub repo ever (9k to 188k stars in 60 days). Self-hosted agent across WhatsApp, Telegram, Slack, Discord, Signal. 5,700+ community skills.                                                  |
...
| [LibreChat](https://github.com/danny-avila/LibreChat) ⭐ 44,882 \| 🐛 792 \| 🌐 TypeScript \| 📅 2026-09-24         | Self-hosted multi-model chat. All major providers.                                                                                                                                                             |
| [LobeChat](https://github.com/lobehub/lobe-chat) ⭐ 82,803 \| 🐛 972 \| 🌐 TypeScript \| 📅 2026-09-24              | OSS ChatGPT/Gemini UI. Plugin system. Multi-modal.                                                                                                                                                             |
...
| [Anything LLM](https://github.com/Mintplex-Labs/anything-llm) ⭐ 66,423 \| 🐛 343 \| 🌐 JavaScript \| 📅 2026-09-24 | All-in-one AI app. RAG, agents. Desktop + Docker.                                                                                                                                                              |
| [DB-GPT](https://github.com/eosphoros-ai/DB-GPT) ⭐ 20,047 \| 🐛 457 \| 🌐 Python \| 📅 2026-09-16                  | Data interaction with local LLM. 100% private.                                                                                                                                                                 |
...
| [A2A (Agent-to-Agent)](https://github.com/google/A2A) ⭐ 25,923 \| 🐛 262 \| 🌐 Shell \| 📅 2026-09-22     | Google protocol for inter-agent communication. Horizontal agent collaboration.                                                                     |
...
| [OpenAPI](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,233 \| 🐛 79 \| 🌐 Markdown \| 📅 2026-09-24 | Industry-standard API spec. Foundation for agent tools.                                                                                            |
...
| Tool                                                                                                 | Description                                                                                                   |
| ---------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| [Agentify](https://github.com/koriyoshi2041/agentify) ⭐ 39 \| 🐛 0 \| 🌐 TypeScript \| 📅 2026-03-16 | CLI to transform OpenAPI specs into 9 agent formats (MCP, AGENTS.md, Claude tools, etc.). `npx agentify-cli`. |
...
| Tool                                                                                            | Description                                                                                                                                                                            |
| ----------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Entroly](https://github.com/juyterman1000/entroly) ⭐ 468 \| 🐛 0 \| 🌐 Python \| 📅 2026-09-24 | Context engineering engine. 100% codebase visibility with 78% fewer tokens. Knapsack-optimal selection, SimHash dedup, RL from response quality. Rust engine, <10ms. MCP + HTTP proxy. |

### Tracing and Monitoring

| Tool                                                                                                     | Description                                                                                                                          |
| -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| [Langfuse](https://github.com/langfuse/langfuse) ⭐ 35,016 \| 🐛 933 \| 🌐 TypeScript \| 📅 2026-09-24    | OSS LLM observability. Traces, evals, prompts.                                                                                       |
...
| [Arize Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,604 \| 🐛 1,044 \| 🌐 Python \| 📅 2026-09-24  | OSS AI observability. Traces, evals, embeddings.                                                                                     |
| [Helicone](https://github.com/Helicone/helicone) ⭐ 6,176 \| 🐛 158 \| 🌐 TypeScript \| 📅 2026-09-16     | OSS LLM observability. One-line integration.                                                                                         |
...
| ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------ |
| [SWE-bench](https://github.com/princeton-nlp/SWE-bench) ⭐ 5,904 \| 🐛 20 \| 🌐 Python \| 📅 2026-09-18 | Industry standard for coding agents. Top: 80.9% (Claude Opus 4.6). |
| [AgentBench](https://github.com/THUDM/AgentBench) ⭐ 3,746 \| 🐛 77 \| 🌐 Python \| 📅 2026-02-08       | 8-environment LLM agent benchmark.                                 |
...
| [Qwen3.6-Plus](https://github.com/QwenLM/Qwen3) ⭐ 27,656 \| 🐛 68 \| 🌐 Python \| 📅 2026-01-09                | Alibaba   | Various   | ⭐ **NEW (Apr 2026)** Agentic focus. 1M ctx. Repo-level coding. MCP-native. |
| [Qwen3.5-Omni](https://github.com/QwenLM/Qwen3) ⭐ 27,656 \| 🐛 68 \| 🌐 Python \| 📅 2026-01-09                | Alibaba   | 397B MoE  | Native multimodal. Text, image, audio.                                     |
| [DeepSeek V3/R1](https://github.com/deepseek-ai/DeepSeek-V3) ⭐ 104,489 \| 🐛 256 \| 🌐 Python \| 📅 2025-08-28 | DeepSeek  | 671B MoE  | 68x cheaper. Strong reasoning. V4 Lite in preview.                         |
| [Gemma 4](https://github.com/google-deepmind/gemma) ⭐ 5,746 \| 🐛 330 \| 🌐 Python \| 📅 2026-09-16            | Google    | 2B-31B    | ⭐ **NEW (Apr 2026)** Consumer/IoT optimized. E2B, E4B variants.            |
...
| [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) ⭐ 7,187 \| 🐛 238 \| 🌐 Python \| 📅 2026-09-24 | NVIDIA. Programmable conversation guardrails.                                    |
...
| [PentestGPT](https://github.com/GreyDGL/PentestGPT) ⭐ 15,578 \| 🐛 87 \| 🌐 Python \| 📅 2026-07-14         | GPT-powered pentesting. Automated reasoning.                                                                                |
...
* [Microsoft GenAI for Beginners](https://github.com/microsoft/generative-ai-for-beginners) ⭐ 120,463 | 🐛 8 | 🌐 Jupyter Notebook | 📅 2026-09-24 - 21-lesson course
* [OpenAI Cookbook](https://github.com/openai/openai-cookbook) ⭐ 76,165 | 🐛 300 | 🌐 Jupyter Notebook | 📅 2026-09-23 - Practical API guides
* [Anthropic Cookbook](https://github.com/anthropics/anthropic-cookbook) ⭐ 52,964 | 🐛 342 | 🌐 Jupyter Notebook | 📅 2026-09-24 - Claude agent recipes
